<?php
   include_once('blk_Carta_PDFView_session.php');
   @session_start() ;
   $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_prod']       = "";
   $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_conf']       = "";
   $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imagens']    = "";
   $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imag_temp']  = "";
   $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_doc']        = "";
//
class blk_Carta_PDFView_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "blk_Carta_PDFView"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/carta_PDF';
      ...
      {
          include_once("blk_Carta_PDFView_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_Carta_PDFView"]))
          {
              foreach ($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_Carta_PDFView"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['iframe_menu'] && (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['sc_outra_jan']) || !$_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blk_Carta_PDFView_erro.class.php"); 
      $this->Erro = new blk_Carta_PDFView_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blk_Carta_PDFView'); 
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['sub_dir'] = array(); 
      $_SESSION['hticnsdata']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['hticnsdata']['sc_connection']) && !empty($_SESSION['hticnsdata']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao']) && $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil']) && $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao'])) ? $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil']) && !empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['embutida_init']) 
      {
          if (!isset($_SESSION['blk_Carta_PDFView_CodeItem'])) 
          {
              $this->nm_falta_var .= "blk_Carta_PDFView_CodeItem; ";
          }
          if (!isset($_SESSION['blk_Carta_PDFView_ID_Projeto'])) 
          {
              $this->nm_falta_var .= "blk_Carta_PDFView_ID_Projeto; ";
          }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['decimal_db'] = $_SESSION['hticnsdata']['glo_decimal_db']; 
      }
      if (isset($_SESSION['hticnsdata']['glo_date_separator']) && !empty($_SESSION['hticnsdata']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['hticnsdata']['nm_sc_retorno']) && !empty($_SESSION['hticnsdata']['nm_sc_retorno']) && isset($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['hticnsdata']['blk_Carta_PDFView']['glo_nm_conexao'], $this->root . $this->path_prod, 'CNSData'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_Carta_PDFView']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blk_Carta_PDFView_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['hticnsdata']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blk_Carta_PDFView']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blk_Carta_PDFView']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_Carta_PDFView']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_Carta_PDFView'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_Carta_PDFView']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_Carta_PDFView']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blk_Carta_PDFView') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_Carta_PDFView']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['blk_Carta_PDFView']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['blk_Carta_PDFView']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['blk_Carta_PDFView']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['hticnsdata']['glo_senha_protect'])) ? $_SESSION['hticnsdata']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blk_Carta_PDFView_erro.class.php"); 
      $this->Erro      = new blk_Carta_PDFView_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['hticnsdata']['blk_Carta_PDFView']['contr_erro'] = 'on';
...
if (!isset($_SESSION['blk_Carta_PDFView_ID_Projeto'])) {$_SESSION['blk_Carta_PDFView_ID_Projeto'] = "";}
if (!isset($this->sc_temp_blk_Carta_PDFView_ID_Projeto)) {$this->sc_temp_blk_Carta_PDFView_ID_Projeto = (isset($_SESSION['blk_Carta_PDFView_ID_Projeto'])) ? $_SESSION['blk_Carta_PDFView_ID_Projeto'] : "";}
if (!isset($_SESSION['blk_Carta_PDFView_CodeItem'])) {$_SESSION['blk_Carta_PDFView_CodeItem'] = "";}
if (!isset($this->sc_temp_blk_Carta_PDFView_CodeItem)) {$this->sc_temp_blk_Carta_PDFView_CodeItem = (isset($_SESSION['blk_Carta_PDFView_CodeItem'])) ? $_SESSION['blk_Carta_PDFView_CodeItem'] : "";}
...
if ($this->sc_temp_blk_Carta_PDFView_CodeItem == "SolicitacaoAutorizacaoVistoria") $assunto = $this->Ini->Nm_lang['lang_label_projectPDF1'];
if ($this->sc_temp_blk_Carta_PDFView_CodeItem == "LaudoVistoria") $assunto = $this->Ini->Nm_lang['lang_label_projectPDF2'];
if ($this->sc_temp_blk_Carta_PDFView_CodeItem == "DeclaracaoResponsabilidadeTecnica") $assunto = $this->Ini->Nm_lang['lang_label_projectPDF3'];
...
$modelProjetos = new Projetos($this);

$options = getOptionDompdf();
$options->set('defaultFont', 'Arial');
$dompdf = getDompdfObj($options);

$Code = $this->sc_temp_blk_Carta_PDFView_CodeItem;
$table = "tb_pi".strtolower($this->sc_temp_blk_Carta_PDFView_CodeItem);
$ID_Projeto = $this->sc_temp_blk_Carta_PDFView_ID_Projeto;

$projeto = $modelProjetos->getById(intval($this->sc_temp_blk_Carta_PDFView_ID_Projeto));
if ($this->sc_temp_blk_Carta_PDFView_CodeItem == "SolicitacaoAutorizacaoVistoria") {
	if ($projeto) $projeto = $projeto[0];
	$projetoTipo = $projeto["ProjetoTipoCode"];
}
...
;
_select($this->rs );
$this->rs  = isset($this->rs [0]) ? $this->rs [0] : false;
...
$html = '<html>
		<head>'.$cssPDF.'
			...
			.footer { position: fixed; bottom: 0px;font-size:12px;color:rgb(150, 150, 150)}
		...
		<body>
			<div class="header">
				...
				$html .= '<td colspan="4" class="col-4 center headerBlock">
						'.($this->rs  ?$this->getImg($this->rs ["bloco1_Tipo_OPC"], $this->rs ["bloco1_ID_OPC"]) : "").'
					</td>
					<td colspan="4" class="col-4 center headerBlock">
						'.($this->rs  ?$this->getImg($this->rs ["bloco2_Tipo_OPC"], $this->rs ["bloco2_ID_OPC"]) : "").'
					</td>
					<td colspan="4" class="col-4 center headerBlock">
						'.($this->rs  ?$this->getImg($this->rs ["bloco3_Tipo_OPC"], $this->rs ["bloco3_ID_OPC"]) : "").'
					</td>';
		$html .= '</tr>
				</table>
				<!--<span class="pagenum"></span>-->
			</div>
			<div class="footer center" style="bottom:30px"><img src="../_lib/img/sys__NM__img__NM__GLOBALBLUE.png" style="width:150px;margin-bottom:3px;"><div><span>Documento emitido através do sistema CNSDATA em '.date("d/m/Y").'</span></div></div>
			<div class="content">
				<span class="data">'.date("d/m/Y").'</span>
				'.($this->rs  ? $this->rs ["CartaConteudo"] : "").'				
			</div>
		</body>
	</html>';
...
if (file_exists($tmpPDF)) {
	...
	$filename = $this->sc_temp_form_pi_ProtocoloHex."_".$this->sc_temp_form_pi_CodeItem.".pdf";
...
header('Expires: 0');
readfile($tmpPDF);
if (isset($this->sc_temp_blk_Carta_PDFView_CodeItem)) {$_SESSION['blk_Carta_PDFView_CodeItem'] = $this->sc_temp_blk_Carta_PDFView_CodeItem;}
if (isset($this->sc_temp_blk_Carta_PDFView_ID_Projeto)) {$_SESSION['blk_Carta_PDFView_ID_Projeto'] = $this->sc_temp_blk_Carta_PDFView_ID_Projeto;}
...
$_SESSION['hticnsdata']['blk_Carta_PDFView']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
if ($Tipo_OPC == "O") {
	...
	$sql = "select IMG_Logo from tb_condominos WHERE ID_Condomino = '$ID_OPC'";
      ...
      $_SESSION['hticnsdata']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['hticnsdata']['sc_sql_ult_conexao'] = ''; 
      if ($rsimage = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $rsimage = false;
          $rsimage_erro = $this->Db->ErrorMsg();
      } 
;
_select($rsimage );

return$this->getImgHtml($rsimage , false);
$_SESSION['hticnsdata']['blk_Carta_PDFView']['contr_erro'] = 'off';
}
function getImgClient($projeto=[])
{
$_SESSION['hticnsdata']['blk_Carta_PDFView']['contr_erro'] = 'on';
...
if ($projeto["ProjetoTipoCode"] == "abordagem") {
	$sql = "SELECT IMG_Logo FROM tb_operadoras WHERE ID_Operadoras = '".$projeto["ID_Operadora"]."'";
} else {
	$sql = "select IMG_Logo from tb_condominos WHERE ID_Condomino = '".$projeto["ID_Condominos"]."'";
}
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blk_Carta_PDFView($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($_POST["blk_Carta_PDFView_CodeItem"])) 
   {
       $_SESSION["blk_Carta_PDFView_CodeItem"] = $_POST["blk_Carta_PDFView_CodeItem"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_CodeItem"]);
   }
   if (!isset($_POST["blk_Carta_PDFView_CodeItem"]) && isset($_POST["blk_carta_pdfview_codeitem"])) 
   {
       $_SESSION["blk_Carta_PDFView_CodeItem"] = $_POST["blk_carta_pdfview_codeitem"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_CodeItem"]);
   }
   if (isset($_GET["blk_Carta_PDFView_CodeItem"])) 
   {
       $_SESSION["blk_Carta_PDFView_CodeItem"] = $_GET["blk_Carta_PDFView_CodeItem"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_CodeItem"]);
   }
   if (!isset($_GET["blk_Carta_PDFView_CodeItem"]) && isset($_GET["blk_carta_pdfview_codeitem"])) 
   {
       $_SESSION["blk_Carta_PDFView_CodeItem"] = $_GET["blk_carta_pdfview_codeitem"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_CodeItem"]);
   }
   if (!isset($_SESSION["blk_Carta_PDFView_CodeItem"])) 
   {
       $_SESSION["blk_Carta_PDFView_CodeItem"] = "";
   }
   if (isset($_POST["blk_Carta_PDFView_ID_Projeto"])) 
   {
       $_SESSION["blk_Carta_PDFView_ID_Projeto"] = $_POST["blk_Carta_PDFView_ID_Projeto"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_ID_Projeto"]);
   }
   if (!isset($_POST["blk_Carta_PDFView_ID_Projeto"]) && isset($_POST["blk_carta_pdfview_id_projeto"])) 
   {
       $_SESSION["blk_Carta_PDFView_ID_Projeto"] = $_POST["blk_carta_pdfview_id_projeto"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_ID_Projeto"]);
   }
   if (isset($_GET["blk_Carta_PDFView_ID_Projeto"])) 
   {
       $_SESSION["blk_Carta_PDFView_ID_Projeto"] = $_GET["blk_Carta_PDFView_ID_Projeto"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_ID_Projeto"]);
   }
   if (!isset($_GET["blk_Carta_PDFView_ID_Projeto"]) && isset($_GET["blk_carta_pdfview_id_projeto"])) 
   {
       $_SESSION["blk_Carta_PDFView_ID_Projeto"] = $_GET["blk_carta_pdfview_id_projeto"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_ID_Projeto"]);
   }
   if (!isset($_SESSION["blk_Carta_PDFView_ID_Projeto"])) 
   {
       $_SESSION["blk_Carta_PDFView_ID_Projeto"] = "";
   }
   if (isset($_POST["form_pi_ProtocoloHex"])) 
   {
       $_SESSION["form_pi_ProtocoloHex"] = $_POST["form_pi_ProtocoloHex"];
       nm_limpa_str_blk_Carta_PDFView($_SESSION["form_pi_ProtocoloHex"]);
   }
   ...
   if (isset($_POST["form_pi_CodeItem"])) 
   {
       ...
       nm_limpa_str_blk_Carta_PDFView($_SESSION["form_pi_CodeItem"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['iframe_menu'];
       unset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['initialize']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blk_Carta_PDFView' == $sReferer || 'blk_Carta_PDFView_' == substr($sReferer, 0, 18))
       {
           $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['hticnsdata']['sc_outra_jan']) && $_SESSION['hticnsdata']['sc_outra_jan'] == 'blk_Carta_PDFView')
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['sc_outra_jan'] = true;
        unset($_SESSION['hticnsdata']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$hti_cnsdata_init]['blk_Carta_PDFView']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blk_Carta_PDFView_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blk_Carta_PDFView($cadapar[1]);
       ...
       if (!isset($blk_Carta_PDFView_CodeItem) && isset($blk_carta_pdfview_codeitem)) 
       {
           $_SESSION["blk_Carta_PDFView_CodeItem"] = $blk_carta_pdfview_codeitem;
       }
       if (isset($blk_Carta_PDFView_CodeItem)) 
       {
           $_SESSION['blk_Carta_PDFView_CodeItem'] = $blk_Carta_PDFView_CodeItem;
           nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_CodeItem"]);
       }
       if (!isset($blk_Carta_PDFView_ID_Projeto) && isset($blk_carta_pdfview_id_projeto)) 
       {
           $_SESSION["blk_Carta_PDFView_ID_Projeto"] = $blk_carta_pdfview_id_projeto;
       }
       if (isset($blk_Carta_PDFView_ID_Projeto)) 
       {
           $_SESSION['blk_Carta_PDFView_ID_Projeto'] = $blk_Carta_PDFView_ID_Projeto;
           nm_limpa_str_blk_Carta_PDFView($_SESSION["blk_Carta_PDFView_ID_Projeto"]);
       }
   ...
   $contr_blk_Carta_PDFView = new blk_Carta_PDFView_apl();
   $contr_blk_Carta_PDFView->controle();
//
   function nm_limpa_str_blk_Carta_PDFView(&$str)
   {
