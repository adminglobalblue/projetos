<?php
	...
	function emailTemplate ($emailData) {
		$emailData = array_map(function($e){
			$smLogoGB = $_SESSION["baseURL"]."/../_lib/libraries/sys/templates/img/smLogoGB.png";
		   $e = strtr($e, [
				":smLogoGB:" => $smLogoGB,
			   	...
			   	":tableFooter:" => "<table style='width:100%'>
					<tr>
						...
						<td><a href='{$_SESSION["baseURL"]}'><img src='$smLogoGB' style='float:right' width='100px'></a></td>
					</tr>
				</table>"
			]);
		   return $e;
				...
				<html>
					<head>
						...
						<style type="text/css">
							...
							body{width:100% !important;font-family:Arial;} .ReadMsgBody{width:100%;} .ExternalClass{width:100%;} /* Force Hotmail to display emails at full width */
							...
							*/
							.dataTableHeading{
								/*@editable*/ background-color:#dcfffa;
								/*@editable*/ color:#2bb6a3;
													...
													<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
														<tr>
															<td class="headerContent" style="
																background: '.(
																	isset($emailData["alert"]) ? (
																		$emailData["alert"] == "good" ? "#1ab394" : (
																			$emailData["alert"] == "warning" ? "#f8ac59" : (
																				$emailData["alert"] == "bad" ? "#ed5565" : "#1ab394"
																			)
																		)
																	) : "#1ab394"
																).';
																...
																border-radius: 3px 3px 0 0;	
															">
																<span>'.(isset($emailData["title"]) ? $emailData["title"] : "").'</span>
															</td>
														</tr>
													</table>
													<!-- // End Template Header \\ -->
														...
														<tr>
															<td valign="top">
																...
																<table border="0" cellpadding="20" cellspacing="0" width="100%">
																	<tr>
																		<td>
																			'.(isset($emailData["content"]) ? $emailData["content"] : "").'
																		</td>
																	</tr>
																</table>
																	...
																	<tr>
																		<td valign="middle" id="utility">
                                                                            <div mc:edit="std_utility">
																				'.(isset($emailData["footer"]) ? $emailData["footer"] : "GLOBALBLUE | CNSDATA").'
																			</div>
																		</td>
																	</tr>
																</table>
