<?php
//
class form_CadEmpreendimentos_etapa1_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_CadEmpreendimentos_etapa1_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->ID_Empreendimento) && isset($this->id_empreendimento)) 
          {
              $this->ID_Empreendimento = $this->id_empreendimento;
      ...
      elseif (isset($hti_cnsdata_init) && !empty($hti_cnsdata_init) && isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_CadEmpreendimentos_etapa1_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['initialize'];
          if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1']))
          {
              foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['upload_field_info']['img_logo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_CadEmpreendimentos_etapa1_mob',
      ...
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['upload_field_info']['img_rg'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_CadEmpreendimentos_etapa1_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['upload_field_info']['upnpt'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_CadEmpreendimentos_etapa1_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadEmpreendimentos_etapa1_mob']['upload_field_info']['uprelatoriovistoria'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_CadEmpreendimentos_etapa1_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['hticnsdata']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_CadEmpreendimentos_etapa1_mob']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_CadEmpreendimentos_etapa1_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_CadEmpreendimentos_etapa1_mob']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_CadEmpreendimentos_etapa1_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_CadEmpreendimentos_etapa1_mob') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_CadEmpreendimentos_etapa1_mob']['label'] = "Cadastro de Empreendimentos";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_CadEmpreendimentos_etapa1_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['hticnsdata']['error_icon']['form_CadEmpreendimentos_etapa1_mob']  = "<img src=\"" . $this->Ini->path_icones . "/hticnsdata__NM__btn__NM__hticnsdata9_Rhino__NM__nm_hticnsdata9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['hticnsdata']['error_close']['form_CadEmpreendimentos_etapa1_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_logo_ul_name]))
          {
              $this->NM_ajax_info['param']['img_logo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_logo_ul_name];
          }
      ...
      elseif (isset($this->img_logo_ul_name) && '' != $this->img_logo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_logo_ul_name]))
          {
              $this->img_logo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_logo_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_rg_ul_name]))
          {
              $this->NM_ajax_info['param']['img_rg_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_rg_ul_name];
          }
      ...
      elseif (isset($this->img_rg_ul_name) && '' != $this->img_rg_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_rg_ul_name]))
          {
              $this->img_rg_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_field_ul_name'][$this->img_rg_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['first_time'])
      {
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['new']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['update']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['delete']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['first']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['back']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['forward']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['last']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['qsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['dynsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['summary']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['navpage']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['insert']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['update']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['delete']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['first']     = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['back']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['forward']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['last']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['qsearch']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['dynsearch'] = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['summary']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['navpage']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['first']     = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['back']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['forward']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['last']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['qsearch']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['dynsearch'] = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['summary']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['navpage']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_orig'] = " where ID_Empreendimento = '" . $_SESSION['ID_Empreendimento'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_pesq'] = " where ID_Empreendimento = '" . $_SESSION['ID_Empreendimento'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['btn_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['btn_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['new']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['new'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['update']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['delete'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['first']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['first'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['back']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['back'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['forward']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['forward'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['last']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['last'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['qsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['qsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['dynsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['dynsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['summary']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['summary'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['navpage']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['navpage'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['goto']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadEmpreendimentos_etapa1_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_CadEmpreendimentos_etapa1_mob'])) {
              $tmpDashboardButtons = $_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_CadEmpreendimentos_etapa1_mob'];
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['update']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['delete'];
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['field_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['field_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['field_readonly']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['field_readonly']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['hticnsdata']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_CadEmpreendimentos_etapa1_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['iframe_menu'] && (!isset($_SESSION['hticnsdata']['menu_mobile']) || empty($_SESSION['hticnsdata']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_CadEmpreendimentos_etapa1_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_CadEmpreendimentos_etapa1_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_CadEmpreendimentos_etapa1/form_CadEmpreendimentos_etapa1_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_CadEmpreendimentos_etapa1_mob_erro.class.php"); 
      }
      $this->Erro      = new form_CadEmpreendimentos_etapa1_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao']))
         { 
             if ($this->id_empreendimento != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['start']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao'] = "novo";
          unset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadEmpreendimentos_etapa1_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['voltar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['botoes']['voltar'];
          $this->nmgp_botoes['salvar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['botoes']['salvar'];
          $this->nmgp_botoes['Excluir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['botoes']['Excluir'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_CadEmpreendimentos_etapa1_mob_pack_ajax_response();
          exit;
      }
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_id_empreendimentosadmin']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_id_empreendimentosadmin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_id_empreendimentosadmin']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_id_empreendimentosadmin'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_CadEmpreendimentos_etapa1_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_id_empreendimentosadmin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['upnpt']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->upnpt = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['upnpt'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['img_rg']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->img_rg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['img_rg'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['uprelatoriovistoria']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->uprelatoriovistoria = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['uprelatoriovistoria'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['img_logo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->img_logo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select']['img_logo'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['hticnsdata']['form_CadEmpreendimentos_etapa1_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "form_CadEmpreendimentos_etapa1_mob.php";
      ...
      $_SESSION['hticnsdata']['form_CadEmpreendimentos_etapa1_mob']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_CadEmpreendimentos_etapa1_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_CadEmpreendimentos_etapa1_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_CadEmpreendimentos_etapa1_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_CadEmpreendimentos_etapa1_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_CadEmpreendimentos_etapa1_mob_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_form']['img_logo']) && $this->img_logo_limpa != "S")
          {
              $this->img_logo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_form']['img_logo'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_empreendimento']['keyVal'] = form_CadEmpreendimentos_etapa1_mob_pack_protect_string($this->nmgp_dados_form['id_empreendimento']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string('S') => form_CadEmpreendimentos_etapa1_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_active'] . ""));
$aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string('N') => form_CadEmpreendimentos_etapa1_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_inactive'] . ""));
$aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string('P') => form_CadEmpreendimentos_etapa1_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_prospect'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_num_ativo'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_num_ativo'][] = 'N';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_num_ativo'][] = 'P';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['num_ativo']['valList'][$i] = form_CadEmpreendimentos_etapa1_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string('G') => form_CadEmpreendimentos_etapa1_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_big'] . ""));
$aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string('M') => form_CadEmpreendimentos_etapa1_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_medium'] . ""));
$aLookup[] = array(form_CadEmpreendimentos_etapa1_mob_pack_protect_string('P') => form_CadEmpreendimentos_etapa1_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_little'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_perfildoempreendimento'][] = 'G';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_perfildoempreendimento'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['Lookup_perfildoempreendimento'][] = 'P';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['perfildoempreendimento']['valList'][$i] = form_CadEmpreendimentos_etapa1_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_CadEmpreendimentos_etapa1_mob_pack_protect_string(NM_charset_to_utf8($this->id_empreendimentosadmin))]) ? $aLookup[0][form_CadEmpreendimentos_etapa1_mob_pack_protect_string(NM_charset_to_utf8($this->id_empreendimentosadmin))] : "";
   ...
   function ajax_return_values_uprelatoriovistoria($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_CadEmpreendimentos_etapa1_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['hticnsdata']['form_CadEmpreendimentos_etapa1_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->img_rg = $this->img_rg_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('nom_empreendimento', 'num_cnpj', 'end_cep', 'end_logradouro', 'end_numero', 'end_bairro', 'end_complemento', 'end_uf', 'end_cidade', 'localizacao', 'nom_email', 'num_telefonecomercial', 'num_totvs', 'num_ativo', 'perfildoempreendimento', 'id_empreendimentosadmin', 'img_logo', 'img_rg', 'torrelabelframe', 'poplabelframe', 'shaftlabelframe', 'antenariolabelframe', 'bloqueioopelabelframe', 'bloqueioprelabelframe', 'bloqueiotecopelabelframe', 'bloqueiotecprelabelframe', 'inconformidadeslabelframe', 'savedataonclick', 'poelabelframe', 'pontodeencontro', 'deleteonclick', 'id_empreendimento', 'upnpt', 'uprelatoriovistoria'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start'] = 0; 
              }
...
$_SESSION['hticnsdata']['form_CadEmpreendimentos_etapa1_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['parms'] = "id_empreendimento?#?$this->id_empreendimento?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['salvar'] = $this->nmgp_botoes['salvar'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['Excluir'] = $this->nmgp_botoes['Excluir'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['parms'] = "id_empreendimento?#?$this->id_empreendimento?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sub_dir'][1]  = "/../emp_" . $this->nm_tira_formatacao_id_empreendimento($this->id_empreendimento) . "/RG/IMG_Capa";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sub_dir'][2]  = "/../emp_" . $this->nm_tira_formatacao_id_empreendimento($this->id_empreendimento) . "/NPT";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sub_dir'][3]  = "/../emp_" . $this->nm_tira_formatacao_id_empreendimento($this->id_empreendimento) . "/RelatorioVistoria";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['reg_start'] < $qt_geral_reg_form_CadEmpreendimentos_etapa1_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['hticnsdata']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
     ...
     if (!$this->NM_ajax_flag && 'novo' != $this->nmgp_opcao)
     {
        ...
        include_once("form_CadEmpreendimentos_etapa1_mob_form0.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form1.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form2.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form3.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form4.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form5.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form6.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form7.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form8.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form9.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form10.php");
        include_once("form_CadEmpreendimentos_etapa1_mob_form11.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter_form'] . " and (ID_Empreendimento = '" . $_SESSION['ID_Empreendimento'] . "') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_CadEmpreendimentos_etapa1_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['total'] = $qt_geral_reg_form_CadEmpreendimentos_etapa1_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_CadEmpreendimentos_etapa1_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_CadEmpreendimentos_etapa1_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_CadEmpreendimentos_etapa1_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadEmpreendimentos_etapa1_mob']['retorno_edit'] = "";
   }
