...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$hti_cnsdata_init]['login']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['login']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$hti_cnsdata_init]['login']['embutida_parms'];
          unset($_SESSION['sc_session'][$hti_cnsdata_init]['login']['embutida_parms']);
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['login']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$hti_cnsdata_init]['login']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['login']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['login']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($hti_cnsdata_init) && !empty($hti_cnsdata_init) && isset($_SESSION['sc_session'][$hti_cnsdata_init]['login']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$hti_cnsdata_init]['login']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup']) && $_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$hti_cnsdata_init]['login']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          ...
          {
              $_SESSION['hticnsdata']['login']['contr_erro'] = 'on';
       ob_start();
$_SESSION['hticnsdata']['login']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$hti_cnsdata_init]['login']['upload_field_info'] = array();
      ...
      if (!$run_iframe && isset($_SESSION['hticnsdata']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['login']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['login'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['login']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['login']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('login') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['login']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . "";
      ...
      $_SESSION['hticnsdata']['error_icon']['login']  = "<img src=\"" . $this->Ini->path_icones . "/hticnsdata__NM__btn__NM__hticnsdata9_Rhino__NM__nm_hticnsdata9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['hticnsdata']['error_close']['login'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      {
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['new']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['update']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['delete']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['first']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['back']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['forward']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['last']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['qsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['dynsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['summary']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['navpage']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['insert']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['login']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['update']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['login']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['update'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['delete']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['login']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['delete'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['first']     = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['back']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['forward']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['last']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['qsearch']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['dynsearch'] = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['summary']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['navpage']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['first']     = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['back']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['forward']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['last']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['qsearch']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['dynsearch'] = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['summary']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['navpage']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['goto']      = 'on';
          }
      }
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['btn_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['login']['btn_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['login']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['new']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['new'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['update']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['delete'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['first']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['first'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['back']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['back'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['forward']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['forward'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['last']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['last'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['qsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['qsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['dynsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['dynsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['summary']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['summary'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['navpage']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['navpage'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['goto']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['login']['goto'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['login']['dashboard_info']['maximized']) {
          ...
          if (isset($_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['login'])) {
              $tmpDashboardButtons = $_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['login'];
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf']['login']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf']['login']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf']['login']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['update']) && $_SESSION['hticnsdata']['sc_apl_conf']['login']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf']['login']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf']['login']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf']['login']['delete'];
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['field_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['login']['field_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['login']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['field_readonly']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['login']['field_readonly']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['login']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['login']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['login']['exit'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['login']['iframe_menu'] && (!isset($_SESSION['hticnsdata']['menu_mobile']) || empty($_SESSION['hticnsdata']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['login']['start']) && $_SESSION['hticnsdata']['sc_apl_conf']['login']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['login']['opcao'] = "novo";
          unset($_SESSION['hticnsdata']['sc_apl_conf']['login']['start']);
      }
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][0]; 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][0] = $this->usuario; 
          ...
          else
          {
              ...
              if (isset($_SESSION['hticnsdata']['sc_ult_apl_menu']) && in_array("login", $_SESSION['hticnsdata']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
...
$Usuario = $modelUsuarios->find("Nom_UserName = '$this->usuario' AND Num_Ativo != 'R' AND 
	(SELECT (
		CASE
...
if ($Usuario["Num_Ativo"] == 'N') {
	$sendResponse("login", [
		"msg" =>  $this->Ini->Nm_lang['lang_label_loginusuariobloqueado'] ,
		"class" => "alert-danger"
	]);
}

if ($Usuario["Num_Ativo"] == 'BP') {
	$sendResponse("login", [
		"msg" =>  $this->Ini->Nm_lang['lang_label_loginbloqueado_bp'] ,
		"class" => "alert-danger"
	]);
}


if ($Usuario["password"] != md5($this->senha)) {
	$modelLogs->insert([
		"Modulo" => "AUTH",
		"Funcao" => "LOGIN",
		"Classe" => "Usuarios",
	...
	$Usuario["NumTentativasLogin"] = $Usuario["NumTentativasLogin"] ?: 0;
	$modelUsuarios->save("ID_Usuario = '".$Usuario["ID_Usuario"]."'", ["NumTentativasLogin" => ++$Usuario["NumTentativasLogin"]]);
	if ($Usuario["NumTentativasLogin"] > 3) {
		$modelUsuarios->save("ID_Usuario = '".$Usuario["ID_Usuario"]."'", ["Num_Ativo" => "BP"]);
			$modelLogs->insert([
			"Modulo" => "AUTH",
			"Funcao" => "LOGIN",
			"Classe" => "Usuarios",
			"Descricao" => 'Bloqueio de usuário por multiplas tentativas de login',
			"Conteudo" => $Usuario
		]);
	}
...
$modelUsuarios->save("ID_Usuario = '".$Usuario["ID_Usuario"]."'", ["NumTentativasLogin" => 0]);


 
      $nm_select = "SELECT b.Nom_Modulo, b.Nom_Funcao, a.Valor, b.Atributos FROM tb_perfilpermissoes a
			INNER JOIN tb_permissoes b ON b.ID = a.ID_Permissoes AND a.ID_Perfil = '".$Usuario['ID_Perfil']."'"; 
