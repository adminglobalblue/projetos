<?php
   include_once('blk_RelatorioFotografico_PDFView_session.php');
   @session_start() ;
   $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_prod']       = "";
   $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_conf']       = "";
   $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imagens']    = "";
   $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imag_temp']  = "";
   $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_doc']        = "";
//
class blk_RelatorioFotografico_PDFView_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "blk_RelatorioFotografico_PDFView"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20171204"; 
      $this->nm_hr_criacao   = "193741"; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blk_RelatorioFotografico_PDFView';
      ...
      {
          include_once("blk_RelatorioFotografico_PDFView_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_RelatorioFotografico_PDFView"]))
          {
              foreach ($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_RelatorioFotografico_PDFView"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['iframe_menu'] && (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['sc_outra_jan']) || !$_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blk_RelatorioFotografico_PDFView_erro.class.php"); 
      $this->Erro = new blk_RelatorioFotografico_PDFView_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blk_RelatorioFotografico_PDFView'); 
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['sub_dir'] = array(); 
      $_SESSION['hticnsdata']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['hticnsdata']['sc_connection']) && !empty($_SESSION['hticnsdata']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao']) && $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil']) && $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao'])) ? $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil']) && !empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['embutida_init']) 
      {
          if (!isset($_SESSION['form_pi_ID_Projeto'])) 
          {
              $this->nm_falta_var .= "form_pi_ID_Projeto; ";
          }
          if (!isset($_SESSION['pathRelatorioFotografico'])) 
          {
              $this->nm_falta_var .= "pathRelatorioFotografico; ";
          }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['decimal_db'] = $_SESSION['hticnsdata']['glo_decimal_db']; 
      }
      if (isset($_SESSION['hticnsdata']['glo_date_separator']) && !empty($_SESSION['hticnsdata']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['hticnsdata']['nm_sc_retorno']) && !empty($_SESSION['hticnsdata']['nm_sc_retorno']) && isset($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['glo_nm_conexao'], $this->root . $this->path_prod, 'CNSData'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_RelatorioFotografico_PDFView']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blk_RelatorioFotografico_PDFView_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blk_RelatorioFotografico_PDFView_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['hticnsdata']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blk_RelatorioFotografico_PDFView']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blk_RelatorioFotografico_PDFView']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_RelatorioFotografico_PDFView']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_RelatorioFotografico_PDFView'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_RelatorioFotografico_PDFView']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_RelatorioFotografico_PDFView']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blk_RelatorioFotografico_PDFView') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_RelatorioFotografico_PDFView']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blk_RelatorioFotografico_PDFView")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['blk_RelatorioFotografico_PDFView']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['blk_RelatorioFotografico_PDFView']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['blk_RelatorioFotografico_PDFView']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['hticnsdata']['glo_senha_protect'])) ? $_SESSION['hticnsdata']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blk_RelatorioFotografico_PDFView_erro.class.php"); 
      $this->Erro      = new blk_RelatorioFotografico_PDFView_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['contr_erro'] = 'on';
...
if (!isset($_SESSION['pathRelatorioFotografico'])) {$_SESSION['pathRelatorioFotografico'] = "";}
if (!isset($this->sc_temp_pathRelatorioFotografico)) {$this->sc_temp_pathRelatorioFotografico = (isset($_SESSION['pathRelatorioFotografico'])) ? $_SESSION['pathRelatorioFotografico'] : "";}
       sc_include_library("sys", "functions", "functions.php");

$geraPDF = $_GET['geraPDF'] ?? null;
if (!$geraPDF){
	sc_include_library('sys', 'initCustom', 'loading_pdf.php');
$data = [ "subject" => $this->Ini->Nm_lang['lang_label_projectRelatorioFoto'] ];
...
$pathDir = $this->sc_temp_pathRelatorioFotografico;
 unset($_SESSION['pathRelatorioFotografico']);
 unset($this->sc_temp_pathRelatorioFotografico);
;

$sql = "SELECT  
	tb1.ID_projeto as ID_Projeto,
	tb1.ProtocoloHex as ProtocoloHex,
    tb2.bloco1_ID_OPC as bloco1_ID_OPC,
    tb2.bloco1_Tipo_OPC as bloco1_Tipo_OPC,
    tb2.bloco2_ID_OPC as bloco2_ID_OPC,
    tb2.bloco2_Tipo_OPC as bloco2_Tipo_OPC,
    tb2.bloco3_ID_OPC as bloco3_ID_OPC,
    tb2.bloco3_Tipo_OPC as bloco3_Tipo_OPC,
    tb2.InfoAdd as InfoAdd,
    tb2.ControleInterno as ControleInterno,
    tb2.Num_ART as cab_Num_ART
    from tb_projetos tb1
LEFT JOIN tb_picabecalhodoc tb2 ON tb2.ID_Projeto = tb1.ID_projeto
WHERE tb1.Id_projeto = '$ID_Projeto'";
...
if (count($this->rsdata ) && $pathDir) {
	$this->rsdata ["pathDir"] = $pathDir;
	...
	$html = '<html>
		...
		<body>
			...
			<!--<img src="../_lib/img/sys__NM__img__NM__GLOBALBLUE.png" style="width:180px"><br>-->
			<span>Documento emitido pelo do sistema CNSDATA em '.date("d/m/Y").'</span></div>
			<div class="content">
				'.$this->mountHTML_RelatorioFotografico($this->rsdata ).'
			</div>		
		</body>
	</html>';
	...
	if (file_exists($tmpPDF)) {
		...
		$filename = $this->rsdata ["ProtocoloHex"]."_relatorioFotografico.pdf";
...
if (isset($this->sc_temp_pathRelatorioFotografico)) {$_SESSION['pathRelatorioFotografico'] = $this->sc_temp_pathRelatorioFotografico;}
...
$_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
function mountHTML_RelatorioFotografico($rs=[])
{
$_SESSION['hticnsdata']['blk_RelatorioFotografico_PDFView']['contr_erro'] = 'on';
...
if (isset($rs["ID_Projeto"])) {
	...
	$sql = "SELECT b.ID as ID, b.Descricao as Descricao, a.Arquivo as Arquivo FROM tb_piarquivos a 
		INNER JOIN tb_pirelatoriofotografico b ON a.ID_piItem = b.ID AND a.CodeItem = b.CodeItem
		WHERE b.ID_Projeto = '$ID_Projeto' AND a.IDFI = 1";
	 
      $nm_select = $sql; 
      $_SESSION['hticnsdata']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['hticnsdata']['sc_sql_ult_conexao'] = ''; 
      if ($arquivos = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $arquivos = false;
          $arquivos_erro = $this->Db->ErrorMsg();
      } 
;
	_select($arquivos );
	$arquivos  = isset($arquivos [0]) ? $arquivos  : [];
	
	$Arquivos = [];
	if (count($arquivos )) {
		foreach($arquivos  as $row) {
			if(!isset($Arquivos[$row["ID"]])) {
				$Arquivos[$row["ID"]] = [
					"Descricao" => $row["Descricao"],
					"Arquivos" => [$row["Arquivo"]]
				];
			} else {
				array_push($Arquivos[$row["ID"]]["Arquivos"], $row["Arquivo"]);
			}			
		}
	}
	...
	$html = '<div class="cap">
		...
		<br><br><br><br><br><br><br>
		<h1 class="center">RELATÓRIO FOTOGRÁFICO</h1>
	</div>
	<div>
	';
	...
	$breakAfter = false;
	$listImg = array();
	foreach($Arquivos as $i => $data) {
		$listImg[$i] = array();
		$listImg[$i]["Arquivos"] = array();
		$listImg[$i]["breakBefore"] = $nextBreakBefore;
		$listImg[$i]["Descricao"] = '<h4>'.$i.' - '.strtoupper($data["Descricao"]).'</h4>';
		$nextBreakBefore = false;
		foreach($data["Arquivos"] as $if => $file) {	
			$if++;
			if (!(in_array(strtolower(pathinfo($file, PATHINFO_EXTENSION)), ["png","jpg","jpeg"])))  continue;
			$img = file_exists($rs["pathDir"].'/'.$file) ? file_get_contents($rs["pathDir"].'/'.$file) : false;
			if (!$img) continue;
			$resource = @imagecreatefromstring($img);
			if (!$resource) continue;
			$x = $nx = imagesx($resource);
			$y = $ny = imagesy($resource);
			$resolution =  $x / $y;
			if ($resolution >= 1) {
				if ($x > 640) {
					$nx = 640;
			...
			if (count($data["Arquivos"]) == 1 && strlen($data["Descricao"]) > 220 && $ny > 330 || $if == count($data["Arquivos"]) && $ny > 350) {
				$nextBreakBefore = true;
			}
			if ($if == 1 && strlen($data["Descricao"]) > 220 && $ny > 330) {
				$listImg[$i]["breakBefore"] = true;
			}
			
			$listImg[$i]["Arquivos"][$if] = [
				"nx" => $nx,
				"ny" => $ny,
				"img" => '<div style="text-align:center"><img style="width:'.$nx.'px;height:'.$ny.'px" src="data:image/png;base64,'.base64_encode($img).'"></div>'
			];
		}
	}
	foreach ($listImg as $i => $item) {
		$html .= '<div style="'.($item["breakBefore"] ? "page-break-before: always" : "").'">'.$item["Descricao"];
		foreach($item["Arquivos"] as $arquivos) {
			$html .= $arquivos["img"];
		}
		$html .= "</div>";
	}
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blk_RelatorioFotografico_PDFView($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($_POST["form_pi_ID_Projeto"])) 
   {
       ...
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["form_pi_ID_Projeto"]);
   }
   ...
   if (isset($_POST["pathRelatorioFotografico"])) 
   {
       $_SESSION["pathRelatorioFotografico"] = $_POST["pathRelatorioFotografico"];
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["pathRelatorioFotografico"]);
   }
   if (!isset($_POST["pathRelatorioFotografico"]) && isset($_POST["pathrelatoriofotografico"])) 
   {
       $_SESSION["pathRelatorioFotografico"] = $_POST["pathrelatoriofotografico"];
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["pathRelatorioFotografico"]);
   }
   if (isset($_GET["pathRelatorioFotografico"])) 
   {
       $_SESSION["pathRelatorioFotografico"] = $_GET["pathRelatorioFotografico"];
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["pathRelatorioFotografico"]);
   }
   if (!isset($_GET["pathRelatorioFotografico"]) && isset($_GET["pathrelatoriofotografico"])) 
   {
       $_SESSION["pathRelatorioFotografico"] = $_GET["pathrelatoriofotografico"];
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["pathRelatorioFotografico"]);
   }
   if (!isset($_SESSION["pathRelatorioFotografico"])) 
   {
       $_SESSION["pathRelatorioFotografico"] = "";
   }
   if (isset($_POST["form_pi_ProtocoloHex"])) 
   {
       $_SESSION["form_pi_ProtocoloHex"] = $_POST["form_pi_ProtocoloHex"];
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["form_pi_ProtocoloHex"]);
   }
   ...
   if (isset($_POST["form_pi_CodeItem"])) 
   {
       ...
       nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["form_pi_CodeItem"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['iframe_menu'];
       unset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['hticnsdata']['sc_apl_menu_atual'] = "blk_RelatorioFotografico_PDFView";
        $achou = false;
        if (isset($_SESSION['sc_session'][$hti_cnsdata_init]))
        {
            foreach ($_SESSION['sc_session'][$hti_cnsdata_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blk_RelatorioFotografico_PDFView' || $achou)
                {
        ...
        $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['initialize']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blk_RelatorioFotografico_PDFView' == $sReferer || 'blk_RelatorioFotografico_PDFView_' == substr($sReferer, 0, 33))
       {
           $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['hticnsdata']['sc_outra_jan']) && $_SESSION['hticnsdata']['sc_outra_jan'] == 'blk_RelatorioFotografico_PDFView')
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['sc_outra_jan'] = true;
        unset($_SESSION['hticnsdata']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$hti_cnsdata_init]['blk_RelatorioFotografico_PDFView']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blk_RelatorioFotografico_PDFView_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blk_RelatorioFotografico_PDFView($cadapar[1]);
       ...
       if (!isset($pathRelatorioFotografico) && isset($pathrelatoriofotografico)) 
       {
           $_SESSION["pathRelatorioFotografico"] = $pathrelatoriofotografico;
       }
       if (isset($pathRelatorioFotografico)) 
       {
           $_SESSION['pathRelatorioFotografico'] = $pathRelatorioFotografico;
           nm_limpa_str_blk_RelatorioFotografico_PDFView($_SESSION["pathRelatorioFotografico"]);
       }
   ...
   $contr_blk_RelatorioFotografico_PDFView = new blk_RelatorioFotografico_PDFView_apl();
   $contr_blk_RelatorioFotografico_PDFView->controle();
//
   function nm_limpa_str_blk_RelatorioFotografico_PDFView(&$str)
   {
