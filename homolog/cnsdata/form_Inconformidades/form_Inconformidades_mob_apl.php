<?php
//
class form_Inconformidades_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_Inconformidades_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->ID_Inconformidade) && isset($this->id_inconformidade)) 
          {
              $this->ID_Inconformidade = $this->id_inconformidade;
      ...
      elseif (isset($hti_cnsdata_init) && !empty($hti_cnsdata_init) && isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_Inconformidades_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['initialize'];
          if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades']))
          {
              foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$hti_cnsdata_init]['form_Inconformidades_mob']['upload_field_info']['anexos'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_Inconformidades_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['hticnsdata']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_Inconformidades_mob']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_Inconformidades_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_Inconformidades_mob']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_Inconformidades_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_Inconformidades_mob') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_Inconformidades_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tb_inconformidade";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_Inconformidades_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['hticnsdata']['error_icon']['form_Inconformidades_mob']  = "<img src=\"" . $this->Ini->path_icones . "/hticnsdata__NM__btn__NM__hticnsdata9_Rhino__NM__nm_hticnsdata9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['hticnsdata']['error_close']['form_Inconformidades_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['first_time'])
      {
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['new']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['update']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['delete']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['first']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['back']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['forward']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['last']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['qsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['dynsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['summary']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['navpage']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['insert']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['update']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['delete']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['first']     = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['back']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['forward']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['last']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['qsearch']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['dynsearch'] = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['summary']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['navpage']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['first']     = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['back']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['forward']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['last']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['qsearch']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['dynsearch'] = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['summary']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['navpage']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_orig'] = " where ID = '" . $_SESSION['ID_Inconformidade'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_pesq'] = " where ID = '" . $_SESSION['ID_Inconformidade'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['btn_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['btn_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['new']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['new'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['update']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['delete'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['first']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['first'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['back']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['back'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['forward']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['forward'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['last']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['last'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['qsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['qsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['dynsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['dynsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['summary']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['summary'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['navpage']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['navpage'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['goto']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_Inconformidades_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_Inconformidades_mob'])) {
              $tmpDashboardButtons = $_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_Inconformidades_mob'];
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['update']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['delete'];
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['field_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['field_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['field_readonly']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['field_readonly']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['hticnsdata']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_Inconformidades_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['iframe_menu'] && (!isset($_SESSION['hticnsdata']['menu_mobile']) || empty($_SESSION['hticnsdata']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_Inconformidades/form_Inconformidades_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_Inconformidades_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_Inconformidades_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_Inconformidades_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_Inconformidades/form_Inconformidades_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_Inconformidades_mob_erro.class.php"); 
      }
      $this->Erro      = new form_Inconformidades_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['start']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao'] = "novo";
          unset($_SESSION['hticnsdata']['sc_apl_conf']['form_Inconformidades_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['voltar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['botoes']['voltar'];
          $this->nmgp_botoes['salvar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['botoes']['salvar'];
          $this->nmgp_botoes['remover'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['botoes']['remover'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_Inconformidades_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_select']['anexos']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->anexos = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_select']['anexos'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['hticnsdata']['form_Inconformidades_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "form_Inconformidades_mob.php";
      ...
      $this->nm_converte_datas();
      $_SESSION['hticnsdata']['form_Inconformidades_mob']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_Inconformidades_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_Inconformidades_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_Inconformidades_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_Inconformidades_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'id' == $filtro)
...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->id_usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario']) && !in_array($this->id_usuario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->operadora) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora']) && !in_array($this->operadora, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->prestadora) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora']) && !in_array($this->prestadora, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_operadora_tratativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa']) && !in_array($this->id_operadora_tratativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_opepre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_opepre, 11, 0, -0, 99999999999, "N") == false)  
              { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_Inconformidades_mob_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario'] = array(); 
}
...
ORDER BY Nom_Nome";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_Inconformidades_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_Inconformidades_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_usuario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_usuario']['valList'][$i] = form_Inconformidades_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('P') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_serviceprovider'] . ""));
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('O') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_operator'] . ""));
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('E') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_condominium'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_tipo'][] = 'P';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_tipo'][] = 'O';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_tipo'][] = 'E';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_Inconformidades_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_Operadoras";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_operadora'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['operadora']['valList'][$i] = form_Inconformidades_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_RazaoSocial";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_prestadora'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prestadora']['valList'][$i] = form_Inconformidades_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('espera') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_status1'] . ""));
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('aguardando_resposta') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_status2'] . ""));
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('andamento') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_status3'] . ""));
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('concluido') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_status4'] . ""));
$aLookup[] = array(form_Inconformidades_mob_pack_protect_string('bloqueado') => form_Inconformidades_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_status5'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_num_status'][] = 'espera';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_num_status'][] = 'aguardando_resposta';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_num_status'][] = 'andamento';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_num_status'][] = 'concluido';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_num_status'][] = 'bloqueado';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['num_status']['valList'][$i] = form_Inconformidades_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_Operadoras";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['Lookup_id_operadora_tratativa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_operadora_tratativa']['valList'][$i] = form_Inconformidades_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_num_ativo($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
...
$_SESSION['hticnsdata']['form_Inconformidades_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  {
                      include_once 'form_Inconformidades_mob_doc_name.php';
                  }
          ...
          $this->descricaoandamento = $this->descricaoandamento_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start'] = 0; 
              }
...
$_SESSION['hticnsdata']['form_Inconformidades_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['salvar'] = $this->nmgp_botoes['salvar'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['remover'] = $this->nmgp_botoes['remover'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sub_dir'][0]  = "/../emp_" . $this->nm_tira_formatacao_id_empreendimento($this->id_empreendimento) . "/inconformidades/" . $this->nm_tira_formatacao_id($this->id);
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['reg_start'] < $qt_geral_reg_form_Inconformidades_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['hticnsdata']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_Inconformidades_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['csrf_token'];
    }
...
ORDER BY Nom_Operadoras";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter_form'] . " and (ID = '" . $_SESSION['ID_Inconformidade'] . "') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_Inconformidades_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['total'] = $qt_geral_reg_form_Inconformidades_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_Inconformidades_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_Inconformidades_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_Inconformidades_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_Inconformidades_mob']['retorno_edit'] = "";
   }
