<?php
   include_once('blk_downloadProjetoAnexos_session.php');
   @session_start() ;
   $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_prod']       = "";
   $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_conf']       = "";
   $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imagens']    = "";
   $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imag_temp']  = "";
   $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_doc']        = "";
//
class blk_downloadProjetoAnexos_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "blk_downloadProjetoAnexos"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/download_projeto_anexos';
      ...
      {
          include_once("blk_downloadProjetoAnexos_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_downloadProjetoAnexos"]))
          {
              foreach ($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_downloadProjetoAnexos"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['iframe_menu'] && (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['sc_outra_jan']) || !$_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blk_downloadProjetoAnexos_erro.class.php"); 
      $this->Erro = new blk_downloadProjetoAnexos_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blk_downloadProjetoAnexos'); 
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['sub_dir'] = array(); 
      $_SESSION['hticnsdata']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['hticnsdata']['sc_connection']) && !empty($_SESSION['hticnsdata']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao']) && $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil']) && $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao'])) ? $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil']) && !empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['embutida_init']) 
      {
          if (!isset($_SESSION['download_pi_PATH'])) 
          {
              $this->nm_falta_var .= "download_pi_PATH; ";
          }
          if (!isset($_SESSION['download_pi_ID_Projeto'])) 
          {
              $this->nm_falta_var .= "download_pi_ID_Projeto; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['decimal_db'] = $_SESSION['hticnsdata']['glo_decimal_db']; 
      }
      if (isset($_SESSION['hticnsdata']['glo_date_separator']) && !empty($_SESSION['hticnsdata']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['hticnsdata']['nm_sc_retorno']) && !empty($_SESSION['hticnsdata']['nm_sc_retorno']) && isset($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['glo_nm_conexao'], $this->root . $this->path_prod, 'CNSData'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_downloadProjetoAnexos']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blk_downloadProjetoAnexos_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blk_downloadProjetoAnexos_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['hticnsdata']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blk_downloadProjetoAnexos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blk_downloadProjetoAnexos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_downloadProjetoAnexos']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_downloadProjetoAnexos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_downloadProjetoAnexos']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_downloadProjetoAnexos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blk_downloadProjetoAnexos') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_downloadProjetoAnexos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blk_downloadProjetoAnexos")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['blk_downloadProjetoAnexos']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['blk_downloadProjetoAnexos']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['blk_downloadProjetoAnexos']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['hticnsdata']['glo_senha_protect'])) ? $_SESSION['hticnsdata']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blk_downloadProjetoAnexos_erro.class.php"); 
      $this->Erro      = new blk_downloadProjetoAnexos_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['contr_erro'] = 'on';
if (!isset($_SESSION['download_pi_ID_Projeto'])) {$_SESSION['download_pi_ID_Projeto'] = "";}
if (!isset($this->sc_temp_download_pi_ID_Projeto)) {$this->sc_temp_download_pi_ID_Projeto = (isset($_SESSION['download_pi_ID_Projeto'])) ? $_SESSION['download_pi_ID_Projeto'] : "";}
if (!isset($_SESSION['download_pi_PATH'])) {$_SESSION['download_pi_PATH'] = "";}
if (!isset($this->sc_temp_download_pi_PATH)) {$this->sc_temp_download_pi_PATH = (isset($_SESSION['download_pi_PATH'])) ? $_SESSION['download_pi_PATH'] : "";}
   sc_include_library("sys", "functions", "functions.php");
$s = new manageSession(true);


$pathDoc = $this->sc_temp_download_pi_PATH;
 unset($_SESSION['download_pi_PATH']);
 unset($this->sc_temp_download_pi_PATH);
;
$ID_Projeto = $this->sc_temp_download_pi_ID_Projeto;
 unset($_SESSION['download_pi_ID_Projeto']);
 unset($this->sc_temp_download_pi_ID_Projeto);
;
if (!$pathDoc || !$ID_Projeto)$this->closeWindow();

 
      $nm_select = "SELECT ProtocoloHex FROM tb_projetos WHERE ID_projeto = '$ID_Projeto'"; 
...
if (!$this->rsprojeto )$this->closeWindow();

 
      $nm_select = "SELECT a.ID_Projeto as ID_Projeto, b.Code as Code, b.ID_Item as ID_Item FROM cnsdata.tb_projetoitensanalise a
...
if (!$this->listitens )$this->closeWindow();

$ProtocoloHex = $this->rsprojeto ["ProtocoloHex"];
...
if (count($listRs)) {
	...
	if($_GET["downloadAvaibled"] ?? 0){
		echo json_encode(["listRs" => $listFiles]);
		die();
	}
	...
	if (count($listFiles)) {
		...
		if ($zipCreate === TRUE) {
			...
			header('Content-Disposition: attachment; filename="'.$ProtocoloHex.'_anexos.zip"');
...
if (isset($this->sc_temp_download_pi_PATH)) {$_SESSION['download_pi_PATH'] = $this->sc_temp_download_pi_PATH;}
if (isset($this->sc_temp_download_pi_ID_Projeto)) {$_SESSION['download_pi_ID_Projeto'] = $this->sc_temp_download_pi_ID_Projeto;}
$_SESSION['hticnsdata']['blk_downloadProjetoAnexos']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blk_downloadProjetoAnexos($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($_POST["download_pi_PATH"])) 
   {
       $_SESSION["download_pi_PATH"] = $_POST["download_pi_PATH"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_PATH"]);
   }
   if (!isset($_POST["download_pi_PATH"]) && isset($_POST["download_pi_path"])) 
   {
       $_SESSION["download_pi_PATH"] = $_POST["download_pi_path"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_PATH"]);
   }
   if (isset($_GET["download_pi_PATH"])) 
   {
       $_SESSION["download_pi_PATH"] = $_GET["download_pi_PATH"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_PATH"]);
   }
   if (!isset($_GET["download_pi_PATH"]) && isset($_GET["download_pi_path"])) 
   {
       $_SESSION["download_pi_PATH"] = $_GET["download_pi_path"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_PATH"]);
   }
   if (!isset($_SESSION["download_pi_PATH"])) 
   {
       $_SESSION["download_pi_PATH"] = "";
   }
   if (isset($_POST["download_pi_ID_Projeto"])) 
   {
       $_SESSION["download_pi_ID_Projeto"] = $_POST["download_pi_ID_Projeto"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_ID_Projeto"]);
   }
   if (!isset($_POST["download_pi_ID_Projeto"]) && isset($_POST["download_pi_id_projeto"])) 
   {
       $_SESSION["download_pi_ID_Projeto"] = $_POST["download_pi_id_projeto"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_ID_Projeto"]);
   }
   if (isset($_GET["download_pi_ID_Projeto"])) 
   {
       $_SESSION["download_pi_ID_Projeto"] = $_GET["download_pi_ID_Projeto"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_ID_Projeto"]);
   }
   if (!isset($_GET["download_pi_ID_Projeto"]) && isset($_GET["download_pi_id_projeto"])) 
   {
       $_SESSION["download_pi_ID_Projeto"] = $_GET["download_pi_id_projeto"];
       nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_ID_Projeto"]);
   }
   if (!isset($_SESSION["download_pi_ID_Projeto"])) 
   {
       $_SESSION["download_pi_ID_Projeto"] = "";
   }
   if (!empty($glo_perfil))  
   { 
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['iframe_menu'];
       unset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['initialize']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blk_downloadProjetoAnexos' == $sReferer || 'blk_downloadProjetoAnexos_' == substr($sReferer, 0, 26))
       {
           $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['hticnsdata']['sc_outra_jan']) && $_SESSION['hticnsdata']['sc_outra_jan'] == 'blk_downloadProjetoAnexos')
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['sc_outra_jan'] = true;
        unset($_SESSION['hticnsdata']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$hti_cnsdata_init]['blk_downloadProjetoAnexos']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blk_downloadProjetoAnexos_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blk_downloadProjetoAnexos($cadapar[1]);
       ...
       if (!isset($download_pi_PATH) && isset($download_pi_path)) 
       {
           $_SESSION["download_pi_PATH"] = $download_pi_path;
       }
       if (isset($download_pi_PATH)) 
       {
           $_SESSION['download_pi_PATH'] = $download_pi_PATH;
           nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_PATH"]);
       }
       if (!isset($download_pi_ID_Projeto) && isset($download_pi_id_projeto)) 
       {
           $_SESSION["download_pi_ID_Projeto"] = $download_pi_id_projeto;
       }
       if (isset($download_pi_ID_Projeto)) 
       {
           $_SESSION['download_pi_ID_Projeto'] = $download_pi_ID_Projeto;
           nm_limpa_str_blk_downloadProjetoAnexos($_SESSION["download_pi_ID_Projeto"]);
       }
   ...
   $contr_blk_downloadProjetoAnexos = new blk_downloadProjetoAnexos_apl();
   $contr_blk_downloadProjetoAnexos->controle();
//
   function nm_limpa_str_blk_downloadProjetoAnexos(&$str)
   {
