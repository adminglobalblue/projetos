...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_op";$Nm_numeric[] = "id";$Nm_numeric[] = "id_op";
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>grid_tb_pas<?php echo $Img_tit_blk_f ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['hticnsdata']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
    ...
    <TD nowrap class="scFilterLabelOdd css_referente_fil_label" > <?php
...
<?php
 ...
 <SELECT class="scFilterObjectOdd" id="SC_referente"  name="referente"  size="1">
 <OPTION value=""></option>
...
<?php
 ...
 <SELECT class="scFilterObjectEven" id="SC_num_status"  name="num_status"  size="1">
 <OPTION value=""></option>
...
?>
   <span id="idAjaxSelect_statusprojeto">
      <SELECT class="scFilterObjectOdd" id="SC_statusprojeto" name="statusprojeto"  size="1">
       <OPTION value=""></OPTION>
<?php
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>bloco2<?php echo $Img_tit_blk_f ?></TD>
...
?>
   <span id="idAjaxSelect_id_op">
      <SELECT class="scFilterObjectEven" id="SC_id_op" name="id_op"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_2"><?php echo $Img_tit_blk_i ?>block3<?php echo $Img_tit_blk_f ?></TD>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_condominio"  <?php echo $str_hide_condominio?>><?php
      $condominio_look = substr($this->Db->qstr($condominio), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Condominio from (SELECT     ID,     Tipo_OP,     Num_Status,     ID_OP,     Referente,     Cliente,     Origem,     ID_Origem,     GBImprimeDocumento,     Condominio,     End_Obra_Cidade,     DataCriacao,     (select Replace(b.Nom_Status, '%s', IFNULL(a.Num_Analise, 0)) from tb_projetoanalisestatus a INNER JOIN tb_projetostatus b ON b.Code = a.CodeStatus WHERE a.ID_Projeto = tb_pas.ID_Origem order by a.Data DESC LIMIT 1) as statusProjeto FROM     tb_pas  WHERE Num_Ativo != 'R' AND (   ('" . $_SESSION['Num_TipoUsuario'] . "' = 'O' AND ID_OP = '" . $_SESSION['ID_OPE'] . "' AND Tipo_OP = 'O') OR   ('" . $_SESSION['Num_TipoUsuario'] . "' = 'P' AND ID_OP = '" . $_SESSION['ID_OPE'] . "' AND Tipo_OP = 'P') OR    ('" . $_SESSION['Num_TipoUsuario'] . "' = 'E' AND false) OR    ('" . $_SESSION['Num_TipoUsuario'] . "' IN ('G', 'GT'))  ) ) nm_sel_esp where Condominio = '$condominio_look'"; 
      $_SESSION['hticnsdata']['sc_sql_ult_comando'] = $nm_comando; 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cliente" name="cliente_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_end_obra_cidade"  <?php echo $str_hide_end_obra_cidade?>><?php
      $end_obra_cidade_look = substr($this->Db->qstr($end_obra_cidade), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_end_obra_cidade" name="end_obra_cidade_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_id_origem"  <?php echo $str_hide_id_origem?>><?php
      $id_origem_look = substr($this->Db->qstr($id_origem), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "statusprojeto" : return ('class="scFilterObjectOdd"'); break;
         case "id_op" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
