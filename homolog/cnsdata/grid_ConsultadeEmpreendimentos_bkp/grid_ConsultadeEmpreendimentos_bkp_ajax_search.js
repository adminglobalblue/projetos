...
function ajax_delete_filter(parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_filter_delete&hti_cnsdata_init=" + document.F1.hti_cnsdata_init.value + "&hti_cnsdata_session=" + document.F1.hti_cnsdata_session.value + "&NM_filters_del=" + parm
     })
...
function ajax_save_filter(save_name, save_opt, parm, pos)
{
    ...
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_filter_save&hti_cnsdata_init=" + document.F1.hti_cnsdata_init.value + "&hti_cnsdata_session=" + document.F1.hti_cnsdata_session.value + "&nmgp_save_name=" + save_name + "&nmgp_save_option=" + save_opt + "&NM_filters_save=" + parm
     })
...
Table_sv_fil[0] = "id_empreendimento";
Table_sv_fil[1] = "num_cnpj";
Table_sv_fil[2] = "nom_empreendimento";
Table_sv_fil[3] = "nom_email";
Table_sv_fil[4] = "num_telefonecomercial";
Table_sv_fil[5] = "end_logradouro";
Table_sv_fil[6] = "end_numero";
Table_sv_fil[7] = "end_complemento";
Table_sv_fil[8] = "end_bairro";
Table_sv_fil[9] = "end_cidade";
Table_sv_fil[10] = "end_uf";
Table_sv_fil[11] = "end_cep";
Table_sv_fil[12] = "num_totvs";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_filter_select&hti_cnsdata_init=" + document.F1.hti_cnsdata_init.value + "&hti_cnsdata_session=" + document.F1.hti_cnsdata_session.value + "&NM_filters=" + parm
     })
