...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['embutida_parms'];
          unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_OS($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->form_OS_ID) && isset($this->form_os_id)) 
          {
              $this->form_OS_ID = $this->form_os_id;
      ...
      elseif (isset($hti_cnsdata_init) && !empty($hti_cnsdata_init) && isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup']) && $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_OS_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['upload_field_info'] = array();

      $_SESSION['sc_session'][$hti_cnsdata_init]['form_OS']['upload_field_info']['arquivos'] = array(
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['hticnsdata']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_OS']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_OS'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_OS']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_OS']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_OS') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_OS']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tb_os";
      ...
      $_SESSION['hticnsdata']['error_icon']['form_OS']  = "<img src=\"" . $this->Ini->path_icones . "/hticnsdata__NM__btn__NM__hticnsdata9_Rhino__NM__nm_hticnsdata9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['hticnsdata']['error_close']['form_OS'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['first_time'])
      {
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['new']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['update']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['delete']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['first']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['back']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['forward']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['last']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['qsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['dynsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['summary']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['navpage']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['insert']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['update']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['update'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['delete']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['delete'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['first']     = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['back']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['forward']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['last']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['qsearch']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['dynsearch'] = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['summary']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['navpage']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['first']     = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['back']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['forward']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['last']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['qsearch']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['dynsearch'] = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['summary']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['navpage']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_orig'] = " where ID = '" . $_SESSION['form_OS_ID'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_pesq'] = " where ID = '" . $_SESSION['form_OS_ID'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['btn_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['btn_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['new']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['new'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['update']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['delete'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['first']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['first'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['back']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['back'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['forward']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['forward'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['last']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['last'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['qsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['qsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['dynsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['dynsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['summary']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['summary'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['navpage']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['navpage'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['goto']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_OS']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_OS'])) {
              $tmpDashboardButtons = $_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_OS'];
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['update']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['delete'];
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['field_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['field_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['field_readonly']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['field_readonly']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['iframe_menu'] && (!isset($_SESSION['hticnsdata']['menu_mobile']) || empty($_SESSION['hticnsdata']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_OS/form_OS_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_OS_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_OS_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_OS_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_OS/form_OS_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_OS_erro.class.php"); 
      }
      $this->Erro      = new form_OS_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['start']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao'] = "novo";
          unset($_SESSION['hticnsdata']['sc_apl_conf']['form_OS']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['voltar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes']['voltar'];
          $this->nmgp_botoes['inserir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes']['inserir'];
          $this->nmgp_botoes['exportPDF'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes']['exportPDF'];
          $this->nmgp_botoes['confirmeRemover'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes']['confirmeRemover'];
          $this->nmgp_botoes['confirmeEnviar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes']['confirmeEnviar'];
          $this->nmgp_botoes['atualizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes']['atualizar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_select']['arquivos']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->arquivos = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_select']['arquivos'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['hticnsdata']['form_OS']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_redir_atualiz'] == "ok")
          {
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant'] == "incluir")
      {
      ...
      $this->nm_converte_datas();
      $_SESSION['hticnsdata']['form_OS']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_OS']) || !is_array($this->NM_ajax_info['errList']['geral_form_OS']))
              {
                  $this->NM_ajax_info['errList']['geral_form_OS'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_OS'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'id' == $filtro)
...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->id_usuario_acompanhante) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante']) && !in_array($this->id_usuario_acompanhante, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email']) && !in_array($this->email, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->telefone) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone']) && !in_array($this->telefone, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_total_horas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->total_horas, 10, 6, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "; " ; 
                  if (!isset($Campos_Erros['total_horas']))
                  {
    ...
    {
        global $teste_validade;
               if (!empty($this->id_tecnico_assop) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop']) && !in_array($this->id_tecnico_assop, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_usuario_assgb(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_usuario_assgb, 11, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "; " ; 
                  if (!isset($Campos_Erros['id_usuario_assgb']))
                  {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_OS_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante'] = array(); 
}
...
ORDER BY Nom_Nome";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_OS_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_OS_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_usuario_acompanhante'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_usuario_acompanhante']['valList'][$i] = form_OS_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
HAVING email != ''";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_email'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['email']['valList'][$i] = form_OS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
HAVING telefone != ''";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_telefone'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['telefone']['valList'][$i] = form_OS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_OS_pack_protect_string('O') => form_OS_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_upc_operators'] . ""));
$aLookup[] = array(form_OS_pack_protect_string('P') => form_OS_pack_protect_string("" . $this->Ini->Nm_lang['lang_label_upc_providers'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_tipo_assop'][] = 'O';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_tipo_assop'][] = 'P';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_assop']['valList'][$i] = form_OS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop'] = array(); 
}
$aLookup[] = array(form_OS_pack_protect_string('') => form_OS_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
...
GROUP BY tb1.ID";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['Lookup_id_tecnico_assop'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tecnico_assop']['valList'][$i] = form_OS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_enviaronclick($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
$_SESSION['hticnsdata']['form_OS']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  {
                      include_once 'form_OS_doc_name.php';
                  }
          ...
          $this->rg_asscontroladoria = $this->rg_asscontroladoria_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total']);
              }

              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start'] = 0; 
              }
...
$_SESSION['hticnsdata']['form_OS']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['confirmeEnviar'] = $this->nmgp_botoes['confirmeEnviar'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['atualizar'] = $this->nmgp_botoes['atualizar'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sub_dir'][0]  = "/../OS/" . $this->nm_tira_formatacao_id($this->id) . "/";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['reg_start'] < $qt_geral_reg_form_OS;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['hticnsdata']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
     ...
     if (!$this->NM_ajax_flag && 'novo' != $this->nmgp_opcao)
     {
        ...
        include_once("form_OS_form0.php");
        include_once("form_OS_form1.php");
        include_once("form_OS_form2.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['csrf_token'];
    }
...
GROUP BY tb1.ID";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter_form'] . " and (ID = '" . $_SESSION['form_OS_ID'] . "') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_OS = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['total'] = $qt_geral_reg_form_OS;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_OS_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_OS_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_OS_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_OS']['retorno_edit'] = "";
   }
