function ajax_refresh_field(fields, parms)
{
    ...
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_refresh_field&hti_cnsdata_init=" + document.F1.hti_cnsdata_init.value + "&hti_cnsdata_session=" + document.F1.hti_cnsdata_session.value + "&NM_fields_refresh=" + fields + "&NM_parms_refresh=" + parms
     })
