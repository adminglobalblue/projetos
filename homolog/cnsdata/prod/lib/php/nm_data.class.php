...
/*                        $str_result .= (10 > $this->mSeg) ? ("0" . $this->mSeg) : $this->mSeg; alt. para permitir decimais nos segundos*/
    ...
    function MesExtenso($opcao = "int")
    {
        ...
        if (isset($_SESSION['hticnsdata']['sc_tab_meses'][$tipo]))
        {
            $mes[$this->mIdioma][$tipo] = $_SESSION['hticnsdata']['sc_tab_meses'][$tipo];
        }
    ...
    function DiaSemana($opcao = "int")
    {
        ...
        if (isset($_SESSION['hticnsdata']['sc_tab_dias'][$tipo]))
        {
            $dia_arr[$this->mIdioma][$tipo] = $_SESSION['hticnsdata']['sc_tab_dias'][$tipo];
        }
        $dia = $this->mDia;
        $mes = $this->mMes;
        $ano = $this->mAno;
