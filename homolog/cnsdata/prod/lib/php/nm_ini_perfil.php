...
function carrega_perfil($perfil, $dir, $prot = 'S', $dir_prod_conf="")
{
        ...
        if (isset($prod_ini_xml["PROFILE"]) && is_array($prod_ini_xml["PROFILE"]))
    {
                ...
                elseif(isset($_SESSION['hticnsdata']['sc_connection_new'][$perfil]) && is_array($_SESSION['hticnsdata']['sc_connection_new'][$perfil]) && !empty($_SESSION['hticnsdata']['sc_connection_new'][$perfil]))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_servidor']          = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['server'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_usuario']           = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['user'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_senha_protect']     = "N";
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_senha']             = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['password'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_banco']             = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['database'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_tpbanco']           = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['drive'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_use_persistent']    = ($_SESSION['hticnsdata']['sc_connection_new'][$perfil]['persistent']=='Y')?'Y':'N';
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_use_schema']        = "N";
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_decimal_db']        = "";
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_database_encoding'] = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['encoding'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_date_separator']    = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['date_separator'];

                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_use_ssl']           = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['use_ssl'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_key']     = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['mysql_ssl_key'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_cert']    = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['mysql_ssl_cert'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_capath']  = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['mysql_ssl_capath'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_ca']      = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['mysql_ssl_ca'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_cipher']  = $_SESSION['hticnsdata']['sc_connection_new'][$perfil]['mysql_ssl_cipher'];
                }
...
{
        //macro de alterar conexao em tempo de voo
        if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]) && is_array($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]))
        {
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['drive']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['drive']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_tpbanco'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['drive'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['server']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['server']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_servidor'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['server'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['user']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['user']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_usuario'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['user'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['password']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['password']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_senha'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['password'];
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_senha_protect'] = "N";
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['database']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['database']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_banco'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['database'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['persistent']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['persistent']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_use_persistent'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['persistent'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['date_separator']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['date_separator']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_date_separator'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['date_separator'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['encoding']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['encoding']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_database_encoding'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['encoding'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['use_ssl']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['use_ssl']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_use_ssl'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['use_ssl'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_key']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_key'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_key'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_cert']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_cert'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_cert'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_capath']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_capath'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_capath'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_ca']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_ca'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_ca'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_cipher']))
                {
                        $_SESSION['nm_session']['prod_v8'][$perfil]['glo_mysql_ssl_cipher'] = $_SESSION['hticnsdata']['sc_connection_edit'][$perfil]['mysql_ssl_cipher'];
                }
        }
}
...
function db_conect($tpbanco, $servidor, $usuario, $senha, $banco, $protect, $sec="S", $persistent="N", $db2_param="", $database_encoding="", $nm_arr_db_extra_args = array())
{
    ...
    $sDBErrorMsg = isset($_SESSION['hticnsdata']['db_conn_error']) ? $_SESSION['hticnsdata']['db_conn_error'] : "Erro ao estabelecer uma conex�o com o banco de dados = ";

    $nm_reg_prod = nm_reg_prod();

    if ("NmhtiCnsdataAplOk" == $nm_reg_prod || $sec == "N")
    {
        ...
        if ((!isset($_REQUEST['nmgp_opcao']) ||  !in_array($_REQUEST['nmgp_opcao'], array('grafico', 'pdf', 'pdf_res'))) && isset($_SESSION['hticnsdata'][$tst_var]) && $tst_varx != $_SESSION['hticnsdata'][$tst_var] && 0 == $_SESSION['hticnsdata']['sc_cnt_sql'])
        {
            $_SESSION['hticnsdata']['sc_cnt_sql']++;
            if (sc_handle_string($_SESSION['hticnsdata'][$tst_var]) !== false)
            {
...
function db_conect_devel($str_conn, $str_path, $projeto, $opcao = 1)
{
    ...
    $arr_ini  = unserialize(substr(file_get_contents($str_path . '/devel/conf/hticnsdata/hticnsdata.config.php'), 8, -5));
    ...
    if ('NetMake' != $str_conn)
    {
        ...
        if (!$conex->EOF)
        {
            ...
            $mysql_encoding    = decode_string($attr1['mysql_encoding']);
                ...
                elseif(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]) && is_array($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]) && !empty($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]))
                {
                        $tpbanco           = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['drive'];
            $servidor          = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['server'];
            $usuario           = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['user'];
            $senha             = encode_string($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['password']);
            $banco             = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['database'];
            $decimal_db        = "";
            $attr1             = array();
                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['date_separator']))
                        {
                                $date_separator    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['date_separator'];
                        }
            $use_persistent    = ($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['persistent']=='Y')?'Y':'N';
            $use_schema        = "";
            $postgres_encoding = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['encoding'];
            $oracle_encoding   = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['encoding'];
            $mysql_encoding    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['encoding'];

                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['use_ssl']))
                        {
                                $use_ssl    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['use_ssl'];
                        }
                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_key']))
                        {
                                $mysql_ssl_key    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_key'];
                        }
                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_cert']))
                        {
                                $mysql_ssl_cert    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_cert'];
                        }
                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_capath']))
                        {
                                $mysql_ssl_capath    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_capath'];
                        }
                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_ca']))
                        {
                                $mysql_ssl_ca    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_ca'];
                        }
                        if(isset($_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_cipher']))
                        {
                                $mysql_ssl_cipher    = $_SESSION['hticnsdata']['sc_connection_new'][$str_conn]['mysql_ssl_cipher'];
                        }
                }
        ...
        //macro de alterar conexao em tempo de voo
        if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]) && is_array($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]))
        {
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['drive']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['drive']))
                {
                        $tpbanco = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['drive'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['server']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['server']))
                {
                        $servidor = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['server'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['user']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['user']))
                {
                        $usuario = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['user'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['password']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['password']))
                {
                        $senha = encode_string($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['password']);
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['database']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['database']))
                {
                        $banco = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['database'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['persistent']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['persistent']))
                {
                        $persistent = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['persistent'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['date_separator']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['date_separator']))
                {
                        $date_separator = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['date_separator'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['encoding']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['encoding']))
                {
                        $database_encoding = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['encoding'];
                }

                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['use_ssl']) && !empty($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['use_ssl']))
                {
                        $use_ssl = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['use_ssl'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_key']))
                {
                        $mysql_ssl_key = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_key'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_cert']))
                {
                        $mysql_ssl_cert = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_cert'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_capath']))
                {
                        $mysql_ssl_capath = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_capath'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_ca']))
                {
                        $mysql_ssl_ca = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_ca'];
                }
                if(isset($_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_cipher']))
                {
                        $mysql_ssl_cipher = $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn]['mysql_ssl_cipher'];
                }
        }
    ...
    if ($opcao != 1)
    {
        ...
        $_SESSION['hticnsdata']['glo_servidor']          = $servidor;
        $_SESSION['hticnsdata']['glo_usuario']           = $usuario;
        $_SESSION['hticnsdata']['glo_banco']             = $banco;
        $_SESSION['hticnsdata']['glo_senha']             = $senha;
        $_SESSION['hticnsdata']['glo_tpbanco']           = $tpbanco;
        $_SESSION['hticnsdata']['glo_decimal_db']        = $decimal_db;
        $_SESSION['hticnsdata']['glo_senha_protect']     = "S";
        $_SESSION['hticnsdata']['glo_date_separator']    = $date_separator;
        $_SESSION['hticnsdata']['glo_use_persistent']    = $use_persistent;
        $_SESSION['hticnsdata']['glo_use_schema']        = $use_schema;
        $_SESSION['hticnsdata']['glo_database_encoding'] = $str_database_encoding;

        $_SESSION['hticnsdata']['glo_use_ssl']           = $use_ssl;
        $_SESSION['hticnsdata']['glo_mysql_ssl_key']     = $mysql_ssl_key;
        $_SESSION['hticnsdata']['glo_mysql_ssl_cert']    = $mysql_ssl_cert;
        $_SESSION['hticnsdata']['glo_mysql_ssl_capath']  = $mysql_ssl_capath;
        $_SESSION['hticnsdata']['glo_mysql_ssl_ca']      = $mysql_ssl_ca;
        $_SESSION['hticnsdata']['glo_mysql_ssl_cipher']  = $mysql_ssl_cipher;
        return;
    }
    ...
    if(!empty($str_conn_name) && is_array($arr_conn_data) && !empty($arr_conn_data))
    {
        ...
        foreach($arr_tags_available as $tags)
        {
            if(isset($arr_conn_data[$tags]))
            {
                ...
                $_SESSION['hticnsdata']['sc_connection_edit'][$str_conn_name][$tags] = $arr_conn_data[$tags];
            }
        }
    }
}
...
function sc_connection_new($str_conn_name, $arr_conn_data)
{
    if(!empty($str_conn_name) && is_array($arr_conn_data) && !empty($arr_conn_data))
    {
        ...
        if($bol_complete)
        {
            $_SESSION['hticnsdata']['sc_connection_new'][$str_conn_name] = $arr_tags_values;
        }
    }
}
...
function set_php_timezone($nome_aplicacao, $force_timezone = '')
{
    if(empty($force_timezone)) {
        if (
            ...
            isset($_SESSION['nm_session']['php_timezone']) ){
              $_SESSION['hticnsdata']['php_timezone'] = nm_check_php_timezone();
            if ( empty($_SESSION['hticnsdata']['php_timezone']) &&
                (isset($_SESSION['hticnsdata'][$nome_aplicacao]['glo_nm_usa_grupo']) &&
                $_SESSION['hticnsdata'][$nome_aplicacao]['glo_nm_usa_grupo'] == 'S') ||
                (isset($_SESSION['hticnsdata'][$nome_aplicacao]['glo_nm_perfil']) && empty($_SESSION['hticnsdata'][$nome_aplicacao]['glo_nm_perfil']))
            ) {
                $_SESSION['hticnsdata']['php_timezone'] = $_SESSION['nm_session']['php_timezone'];
            }
        }
    ...
    {
        $_SESSION['hticnsdata']['php_timezone'] = $force_timezone;
    }
    if(!empty($_SESSION['hticnsdata']['php_timezone'])){
        @ini_set('date.timezone', $_SESSION['hticnsdata']['php_timezone']);
    }
}
?>