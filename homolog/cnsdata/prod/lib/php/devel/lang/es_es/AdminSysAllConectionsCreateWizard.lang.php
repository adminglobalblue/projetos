...
$nm_lang['lic_new_error_pr_'] = 'Su licencia Professional Edition s&oacute;lo permiten crear conexiones 6. <BR> Por favor, p&oacute;ngase en contacto con sales@hticnsdata.net a migrar a otro tipo de licencia.'; 
$nm_lang['msg_cancel_create_conn'] = '&iquest;Desea cancelar?'; 
$nm_lang['msg_connect_lang'] = 'Cuando se utiliza caracteres multibyte como: &aacute;rabe, chino, japon&eacute;s o ruso, htiCnsdata s&oacute;lo admite la codificaci&oacute;n UTF-8 en las bases de datos'; 
...
$nm_lang['msg_connect_lang'] = 'Cuando se utiliza caracteres multibyte como: &aacute;rabe, chino, japon&eacute;s o ruso, htiCnsdata s&oacute;lo admite la codificaci&oacute;n UTF-8 bases de datos, leer y escribir todos los datos est&aacute;n almacenados y se muestra como la codificaci&oacute;n UTF-8 en su base de datos'; 
