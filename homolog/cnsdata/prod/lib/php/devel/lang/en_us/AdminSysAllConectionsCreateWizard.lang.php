...
$nm_lang['lic_new_error_pr_'] = 'Your license Professiona Edition only allow to create 5 connections.<BR>Please, contact sales@hticnsdata.net to migrate to another license type.'; 
$nm_lang['msg_cancel_create_conn'] = 'Do you wish to cancel ?'; 
$nm_lang['msg_connect_lang'] = 'When using multibyte chars like: Arabic, Chinese, Japanese or Russian, the htiCnsdata only supports UTF-8 encoded databases, all read and written data is now displayed and stored as UTF-8 encoding in your database'; 
