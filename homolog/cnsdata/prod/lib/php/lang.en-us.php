...
$nm_lang['error_password_reserved']        = 'The new password enterd is reserved to htiCnsdata. Please choose a new one different.';
...
// Login
$nm_lang['login_warning'] = 'The default password to access the production environment is <span style="font-weight: bold">hticnsdata</span>. After your first login, you will be prompted to change it for security reasons.';
...
// Dicas
$nm_lang['hint_change_pass']    = 'Change access password to the htiCnsdata production environment manager.';
...
$nm_lang['hint_logout']         = 'Exit the htiCnsdata production environment manager.';
...
$nm_lang['profile_delete_warning'] = 'This option removes permanently the information of a connection of the htiCnsdata production environment. Any application that uses this connection will stop working. If you are sure that the connection can be removed, choose the connection to be deleted and confirm the operation.';
