...
switch ($str_option) {
    ...
    case 'change_pass':
        if (isset($arr_argv['field_pass_old'])) {
            ...
            if ('' == $str_pwd_ini) {
                $str_pwd_ini = 'hticnsdata';
            }
            if ($str_pwd_old != $str_pwd_ini) {
                $arr_error[] = 'error_password_invalid';
            } elseif (('' == $str_pwd_new) || ('hticnsdata' == $str_pwd_new)) {
    ...
    case 'environment':
        if (isset($arr_argv['field_gc_dir'])) {
            ...
            $_SESSION['hticnsdata']['php_timezone'] = $arr_argv['field_php_timezone'];
...
switch ($str_option) {
    ...
    case 'change_pass':
        ...
        if (trim($str_pwd) == "" || $str_pwd == "hticnsdata") {
        ...
        <tr>
            <td align="center">
                ...
                <table class="nmTable" cellpadding="0" cellspacing="8" border="0" width="100%" align="center">
                    ...
                    <?php
                    if (('' == $v_str_pass) || ('hticnsdata' == $v_str_pass)) {
                        ?>
                        <input type="hidden" name="field_pass_old" value="hticnsdata"/>
                    <?php
                    } else {
                        ?>
                        <tr>
...
<html>
<head>
    <title>&lt;htiCnsdata&gt; :: <?php echo $nm_lang['sc_prod']; ?></title>
    ...
    <meta name="generator" content="htiCnsdata"/>
        ...
        <tr>
            <td style='height: 89%'>
                ...
                <div id="loginPartsInfos">
                    ...
                    <br/>
                    <?php
                    if ($v_tp_win != 'change_pass' && (('' == $v_str_pass) || ('hticnsdata' == $v_str_pass))) {
                        ?>
                        <div id="id_login_msg">
                            <?php
                ...
                <table class="nmTable" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr class="nmTableTd">
                        <td class="nmLineV3">
                            ...
                            //$arr_file = @file("http://www.hticnsdata{$site_lang}/docs/{$str_lang}/v81/manual_mp.htm");
                            $arr_file = @file("http://www.hticnsdata{$site_lang}/docs/{$str_lang}/v9/index.html");

                            if (is_array($arr_file) && count($arr_file) > 1) {
                                ?>
                                &nbsp;&nbsp;<a
                                    href="http://www.hticnsdata<?php echo $site_lang; ?>/docs/<?php echo $str_lang; ?>/v9/<?php echo $pub_lang; ?>"
