...
$Nm_cab     = (isset($_SESSION['hticnsdata']['sc_tab_cores']['paleta']))  ? $_SESSION['hticnsdata']['sc_tab_cores']['paleta']  : "htiCnsdata - Paleta de Cores";
$Nm_seta    = (isset($_SESSION['hticnsdata']['sc_tab_cores']['setacor'])) ? $_SESSION['hticnsdata']['sc_tab_cores']['setacor'] : "Seta Cor";
$Nm_atualiz = (isset($_SESSION['hticnsdata']['sc_tab_cores']['atualiz'])) ? $_SESSION['hticnsdata']['sc_tab_cores']['atualiz'] : "Atualizar";
$Nm_cancel  = (isset($_SESSION['hticnsdata']['sc_tab_cores']['cancela'])) ? $_SESSION['hticnsdata']['sc_tab_cores']['cancela'] : "Cancelar";
...
<HEAD>
  <TITLE>htiCnsdata - Paleta de Cores</TITLE>
