...
$_SESSION['hticnsdata']['grid_PAS_SAE']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PAS_SAE']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PAS_SAE']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PAS_SAE']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PAS_SAE']['rtf_name']);
      }
...
$_SESSION['hticnsdata']['grid_PAS_SAE']['contr_erro'] = 'off'; 
   ...
   function NM_export_aprovarpas()
   {
         ...
         $this->aprovarpas = str_replace('<', '&lt;', $this->aprovarpas);
         $this->aprovarpas = str_replace('>', '&gt;', $this->aprovarpas);
         $this->Texto_tag .= "<td>" . $this->aprovarpas . "</td>\r\n";
   }
   //----- download
   function NM_export_download()
   {
         ...
         $this->download = str_replace('>', '&gt;', $this->download);
         $this->Texto_tag .= "<td>" . $this->download . "</td>\r\n";
   }
   //----- num_status
   function NM_export_num_status()
   {
         ...
         $this->look_num_status = str_replace('<', '&lt;', $this->look_num_status);
         $this->look_num_status = str_replace('>', '&gt;', $this->look_num_status);
         $this->Texto_tag .= "<td>" . $this->look_num_status . "</td>\r\n";
   }
   //----- razaosocial
   function NM_export_razaosocial()
   {
         ...
         $this->razaosocial = str_replace('<', '&lt;', $this->razaosocial);
         $this->razaosocial = str_replace('>', '&gt;', $this->razaosocial);
         $this->Texto_tag .= "<td>" . $this->razaosocial . "</td>\r\n";
   }
   //----- cnpj_op
   function NM_export_cnpj_op()
   {
         ...
         $this->cnpj_op = str_replace('<', '&lt;', $this->cnpj_op);
         $this->cnpj_op = str_replace('>', '&gt;', $this->cnpj_op);
         $this->Texto_tag .= "<td>" . $this->cnpj_op . "</td>\r\n";
   }
   //----- referente
   function NM_export_referente()
   {
         ...
         $this->look_referente = str_replace('<', '&lt;', $this->look_referente);
         $this->look_referente = str_replace('>', '&gt;', $this->look_referente);
         $this->Texto_tag .= "<td>" . $this->look_referente . "</td>\r\n";
   }
   //----- cliente
   ...
   function NM_export_recusarpas()
   {
         ...
         $this->recusarpas = str_replace('<', '&lt;', $this->recusarpas);
         $this->recusarpas = str_replace('>', '&gt;', $this->recusarpas);
         $this->Texto_tag .= "<td>" . $this->recusarpas . "</td>\r\n";
   }
   //----- tipo_op
   function NM_export_tipo_op()
   {
         ...
         $this->tipo_op = str_replace('<', '&lt;', $this->tipo_op);
         $this->tipo_op = str_replace('>', '&gt;', $this->tipo_op);
         $this->Texto_tag .= "<td>" . $this->tipo_op . "</td>\r\n";
   }
   //----- id_op
   function NM_export_id_op()
   {
         ...
         $this->id_op = str_replace('<', '&lt;', $this->id_op);
         $this->id_op = str_replace('>', '&gt;', $this->id_op);
         $this->Texto_tag .= "<td>" . $this->id_op . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PAS_SAE']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PAS_SAE']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - tb_pas :: RTF</TITLE>
