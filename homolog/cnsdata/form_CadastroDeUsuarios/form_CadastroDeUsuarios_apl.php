<?php
//
class form_CadastroDeUsuarios_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['embutida_parms'];
          unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_CadastroDeUsuarios($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->grid_ID_Usuario) && isset($this->grid_id_usuario)) 
          {
              $this->grid_ID_Usuario = $this->grid_id_usuario;
      ...
      elseif (isset($hti_cnsdata_init) && !empty($hti_cnsdata_init) && isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup']) && $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_CadastroDeUsuarios_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['upload_field_info'] = array();

      $_SESSION['sc_session'][$hti_cnsdata_init]['form_CadastroDeUsuarios']['upload_field_info']['img_foto'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_CadastroDeUsuarios',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['hticnsdata']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_CadastroDeUsuarios']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['form_CadastroDeUsuarios'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_CadastroDeUsuarios']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_CadastroDeUsuarios']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_CadastroDeUsuarios') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['form_CadastroDeUsuarios']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - tb_usuarios";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_CadastroDeUsuarios")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['hticnsdata']['error_icon']['form_CadastroDeUsuarios']  = "<img src=\"" . $this->Ini->path_icones . "/hticnsdata__NM__btn__NM__hticnsdata9_Rhino__NM__nm_hticnsdata9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['hticnsdata']['error_close']['form_CadastroDeUsuarios'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_field_ul_name'][$this->img_foto_ul_name]))
          {
              $this->NM_ajax_info['param']['img_foto_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_field_ul_name'][$this->img_foto_ul_name];
          }
      ...
      elseif (isset($this->img_foto_ul_name) && '' != $this->img_foto_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_field_ul_name'][$this->img_foto_ul_name]))
          {
              $this->img_foto_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_field_ul_name'][$this->img_foto_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['first_time'])
      {
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['new']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['update']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['delete']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['first']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['back']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['forward']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['last']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['qsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['dynsearch']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['summary']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['navpage']);
          unset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['insert']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['update']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['update'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['delete']) || '' == $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['delete'] = 'off';
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['first']     = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['back']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['forward']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['last']      = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['qsearch']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['dynsearch'] = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['summary']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['navpage']   = 'off';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['first']     = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['back']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['forward']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['last']      = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['qsearch']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['dynsearch'] = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['summary']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['navpage']   = 'on';
              $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_orig'] = " where ID_Usuario = '" . $_SESSION['grid_ID_Usuario'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_pesq'] = " where ID_Usuario = '" . $_SESSION['grid_ID_Usuario'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['btn_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['btn_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['new']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['new'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['update']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['delete'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['first']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['first'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['back']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['back'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['forward']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['forward'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['last']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['last'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['qsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['qsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['dynsearch']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['dynsearch'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['summary']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['summary'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['navpage']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['navpage'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['goto']) && $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['hticnsdata']['sc_apl_conf_lig']['form_CadastroDeUsuarios']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_CadastroDeUsuarios'])) {
              $tmpDashboardButtons = $_SESSION['hticnsdata']['dashboard_toolbar'][$tmpDashboardApp]['form_CadastroDeUsuarios'];
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['insert']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['insert'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['update']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['update'];
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['delete']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['delete'];
      }

      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['field_display']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['field_display']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['field_readonly']) && !empty($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['field_readonly']))
      {
          foreach ($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_form'];
      ...
      if (isset($_SESSION['hticnsdata']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_CadastroDeUsuarios", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['iframe_menu'] && (!isset($_SESSION['hticnsdata']['menu_mobile']) || empty($_SESSION['hticnsdata']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_CadastroDeUsuarios/form_CadastroDeUsuarios_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_CadastroDeUsuarios_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_CadastroDeUsuarios_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_CadastroDeUsuarios_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_CadastroDeUsuarios/form_CadastroDeUsuarios_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_CadastroDeUsuarios_erro.class.php"); 
      }
      $this->Erro      = new form_CadastroDeUsuarios_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao']))
         { 
             if ($this->id_usuario != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['start']) && $_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao'] = "novo";
          unset($_SESSION['hticnsdata']['sc_apl_conf']['form_CadastroDeUsuarios']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['voltarGrid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['botoes']['voltarGrid'];
          $this->nmgp_botoes['salvar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['botoes']['salvar'];
          $this->nmgp_botoes['confimeRemover'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['botoes']['confimeRemover'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_CadastroDeUsuarios_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['hticnsdata']['form_CadastroDeUsuarios']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_redir_atualiz'] == "ok")
          {
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opc_ant'] == "incluir")
      {
      ...
      $this->nm_converte_datas();
      $_SESSION['hticnsdata']['form_CadastroDeUsuarios']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_CadastroDeUsuarios']) || !is_array($this->NM_ajax_info['errList']['geral_form_CadastroDeUsuarios']))
              {
                  $this->NM_ajax_info['errList']['geral_form_CadastroDeUsuarios'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_CadastroDeUsuarios'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    {
        global $teste_validade;
               if (!empty($this->num_tipousuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario']) && !in_array($this->num_tipousuario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->operadora) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora']) && !in_array($this->operadora, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->prestadora) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora']) && !in_array($this->prestadora, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->empreendimento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento']) && !in_array($this->empreendimento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->id_perfil) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil']) && !in_array($this->id_perfil, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_ope(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_ope, 11, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "ID OPE; " ; 
                  if (!isset($Campos_Erros['id_ope']))
                  {
...
;
    ...
    {
        global $teste_validade;
               if (!empty($this->departamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento']) && !in_array($this->departamento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if ($this->gbttecempreendimentos != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos']) && !in_array($dados_gbttecempreendimentos_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos']))
                       {
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_contexto_id_ope(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->contexto_id_ope, 11, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_criadopor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->criadopor, 11, 0, 0, 0, "N") == false)  
              { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_CadastroDeUsuarios_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_form']['img_foto']) && $this->img_foto_limpa != "S")
          {
              $this->img_foto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_form']['img_foto'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_usuario']['keyVal'] = form_CadastroDeUsuarios_pack_protect_string($this->nmgp_dados_form['id_usuario']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('30') => form_CadastroDeUsuarios_pack_protect_string("30 " . $this->Ini->Nm_lang['lang_label_dias'] . ""));
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('60') => form_CadastroDeUsuarios_pack_protect_string("60 " . $this->Ini->Nm_lang['lang_label_dias'] . ""));
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('90') => form_CadastroDeUsuarios_pack_protect_string("90 " . $this->Ini->Nm_lang['lang_label_dias'] . ""));
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('120') => form_CadastroDeUsuarios_pack_protect_string("120 " . $this->Ini->Nm_lang['lang_label_dias'] . ""));
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('180') => form_CadastroDeUsuarios_pack_protect_string("180 " . $this->Ini->Nm_lang['lang_label_dias'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_diasinatividade'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_diasinatividade'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_diasinatividade'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_diasinatividade'][] = '120';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_diasinatividade'][] = '180';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['diasinatividade']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
...
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('S') => form_CadastroDeUsuarios_pack_protect_string(""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_ativo'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['num_ativo']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario'] = array(); 
}
$aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string('') => form_CadastroDeUsuarios_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario'][] = '';
...
SELECT 'E', 'Empreendimento' FROM tb_usuarios WHERE 'E' IN (" . $_SESSION['profile_TypeUserCreate'] . ")";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_CadastroDeUsuarios_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_CadastroDeUsuarios_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_num_tipousuario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['num_tipousuario']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_Operadoras";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_operadora'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['operadora']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_RazaoSocial";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_prestadora'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prestadora']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_Empreendimento";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_empreendimento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['empreendimento']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nom_Perfil";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_id_perfil'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_perfil']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
ORDER BY Nome";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_departamento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['departamento']['valList'][$i] = form_CadastroDeUsuarios_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
order by Nom_Empreendimento";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['Lookup_gbttecempreendimentos'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   function ajax_return_values_removido_em($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['hticnsdata']['form_CadastroDeUsuarios']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->departamento = $this->departamento_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total']);
              }

              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start'] = 0; 
              }
...
$_SESSION['hticnsdata']['form_CadastroDeUsuarios']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['parms'] = "id_usuario?#?$this->id_usuario?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['hticnsdata']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['parms'] = "id_usuario?#?$this->id_usuario?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['reg_start'] < $qt_geral_reg_form_CadastroDeUsuarios;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['hticnsdata']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
    ...
    include_once("form_CadastroDeUsuarios_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['csrf_token'];
    }
...
ORDER BY Nome";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter_form'] . " and (ID_Usuario = '" . $_SESSION['grid_ID_Usuario'] . "') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_CadastroDeUsuarios = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['total'] = $qt_geral_reg_form_CadastroDeUsuarios;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_CadastroDeUsuarios_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_CadastroDeUsuarios_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_CadastroDeUsuarios_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_CadastroDeUsuarios']['retorno_edit'] = "";
   }
