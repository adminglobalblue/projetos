<?php
   include_once('blk_OS_PDFView_session.php');
   @session_start() ;
   $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_prod']       = "";
   $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_conf']       = "";
   $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imagens']    = "";
   $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imag_temp']  = "";
   $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_doc']        = "";
//
class blk_OS_PDFView_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "blk_OS_PDFView"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20171226"; 
      $this->nm_hr_criacao   = "102451"; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/os_pdf';
      ...
      {
          include_once("blk_OS_PDFView_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_OS_PDFView"]))
          {
              foreach ($_SESSION['hticnsdata']['dashboard_targets'][$sTmpDashboardApp]["blk_OS_PDFView"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['iframe_menu'] && (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['sc_outra_jan']) || !$_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blk_OS_PDFView_erro.class.php"); 
      $this->Erro = new blk_OS_PDFView_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blk_OS_PDFView'); 
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['sub_dir'] = array(); 
      $_SESSION['hticnsdata']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['hticnsdata']['sc_connection']) && !empty($_SESSION['hticnsdata']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao']) && $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil']) && $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao'])) ? $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil']) && !empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['embutida_init']) 
      {
          if (!isset($_SESSION['form_OS_Num_SAE'])) 
          {
              $this->nm_falta_var .= "form_OS_Num_SAE; ";
          }
          if (!isset($_SESSION['form_OS_ID'])) 
          {
              $this->nm_falta_var .= "form_OS_ID; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['decimal_db'] = $_SESSION['hticnsdata']['glo_decimal_db']; 
      }
      if (isset($_SESSION['hticnsdata']['glo_date_separator']) && !empty($_SESSION['hticnsdata']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['hticnsdata']['nm_sc_retorno']) && !empty($_SESSION['hticnsdata']['nm_sc_retorno']) && isset($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao']) && !empty($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['hticnsdata']['blk_OS_PDFView']['glo_nm_conexao'], $this->root . $this->path_prod, 'CNSData'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_OS_PDFView']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blk_OS_PDFView_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['hticnsdata']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blk_OS_PDFView']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blk_OS_PDFView']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_OS_PDFView']))
          {
              $this->sc_init_menu = $_SESSION['hticnsdata'][$_SESSION['hticnsdata']['menu_atual']]['sc_init']['blk_OS_PDFView'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_OS_PDFView']))
          {
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_OS_PDFView']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blk_OS_PDFView') . "/";
               $_SESSION['hticnsdata']['menu_apls'][$_SESSION['hticnsdata']['menu_atual']][$this->sc_init_menu]['blk_OS_PDFView']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['hticnsdata']['sc_apl_conf']['blk_OS_PDFView']['exit']) && $_SESSION['hticnsdata']['sc_apl_conf']['blk_OS_PDFView']['exit'] != '')
      {
          $_SESSION['hticnsdata']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['hticnsdata']['sc_apl_conf']['blk_OS_PDFView']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['hticnsdata']['glo_senha_protect'])) ? $_SESSION['hticnsdata']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blk_OS_PDFView_erro.class.php"); 
      $this->Erro      = new blk_OS_PDFView_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['hticnsdata']['blk_OS_PDFView']['contr_erro'] = 'on';
if (!isset($_SESSION['form_OS_Num_SAE'])) {$_SESSION['form_OS_Num_SAE'] = "";}
...
if (!isset($_SESSION['form_OS_ID'])) {$_SESSION['form_OS_ID'] = "";}
if (!isset($this->sc_temp_form_OS_ID)) {$this->sc_temp_form_OS_ID = (isset($_SESSION['form_OS_ID'])) ? $_SESSION['form_OS_ID'] : "";}
     $geraPDF = $_GET['geraPDF'] ?? null;
if (!$geraPDF){
	sc_include_library('sys', 'initCustom', 'loading_pdf.php');
$data = [ "subject" => $this->Ini->Nm_lang['lang_label_orderservice'] ];
	loadingPDF($this,$data); 
	die();
}

$strCloseWindow = "<script>window.close();</script>";
if(!$this->sc_temp_form_OS_ID) {
	echo $strCloseWindow;
	return;
}
...
$Os = $_Os->getByID(intval($this->sc_temp_form_OS_ID));
if (!$Os) {
	echo $strCloseWindow;
	return;
}
...
$Sae["Data_1"]  = date("d/m/Y H:i", strtotime($Sae["Data_Inicio"]." ".$Sae["Hora_Inicio"]));
$Sae["Data_2"]  = date("d/m/Y H:i", strtotime($Sae["Data_Fim"]." ".$Sae["Hora_Fim"]));
$Sae["Total_Horas"] = convertNumberInStringHour(convertHourInNumberInt(strtotime($Sae["Data_Inicio"]." ".$Sae["Hora_Inicio"]), strtotime($Sae["Data_Fim"]." ".$Sae["Hora_Fim"])));
$Sae["Data_Inicio"]  = date("d/m/Y", strtotime($Sae["Data_Inicio"]));

$Acompanhante = $_Usuarios->getById(intval($Os["ID_Usuario_Acompanhante"]));
if (!$Acompanhante) {
	$Acompanhante["Nom_Nome"] = "";
} else {
	$Acompanhante = $Acompanhante[0];
}
$Acompanhante["Email"] = $_Usuarios->getFirstEmailById(intval($Os["ID_Usuario_Acompanhante"]));
$Acompanhante["Telefone"] = $_Usuarios->getFirstTelefoneById(intval($Os["ID_Usuario_Acompanhante"]));

$AssGB = $_Usuarios->getById(intval($Os["ID_Usuario_AssGB"]));
if (!$AssGB) {
	$AssGB["Nom_Nome"] = "";
	$AssGB["Num_RG"] = "";
} else {
...
$AssTecnico = $_Tecnicos->getById(intval($Os["ID_Tecnico_AssOP"]));
if (!$AssTecnico) {
	$AssTecnico["Nom_Tecnico"] = "";
	$AssTecnico["Nom_Sobrenome"] = "";
	$AssTecnico["Num_RG"] = "";
} else {
	$AssTecnico = $AssTecnico[0];
}
$AssTecnico["Nom_Nome"] = $AssTecnico["Nom_Tecnico"]." ".$AssTecnico["Nom_Sobrenome"];

$cssPDF = mountCSS(10, 10, 15, 10, "landscape");
$cssPDF .=$this->mountOSCSS();
...
$contentOS .= "<body>
	<div class='headerHtml'>
		<table class='col-12' style='border:none'>
			<tr>
				<td class='col-6' style='border: none' colspan='6' rowspan='2' ><img src='../_lib/img/sys__NM__img__NM__GLOBALBLUE.png' style='width:450px'></td>
				<td class='col-3' colspan='6'>
					<label style='font-size:16px'>".$this->Ini->Nm_lang['lang_label_pdf_os1']."</label>
				</td>
				<td class='col-3' colspan='6'>
					<table class='label-top'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_date']."</label></td></tr>
						<tr><td>".$Sae["Data_Inicio"]."</td></tr>
					</table>
				</td>
			</tr>
			<tr>
				<td class='col-3' colspan='6'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_enterprise']."</label></td></tr>
						<tr><td>".$Sae["Nom_Empreendimento"]."</td></tr>
					</table>
				</td>
				<td class='col-3' colspan='6'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_client']."</label></td></tr>
						<tr><td>".$Sae["Nom_Cliente"]."</td></tr>
					</table>
				</td>
			</tr>
		</table>
	...
	<div class='content'>
		<table class='col-12'>
			<tr>
				<td class='col-4' colspan='4'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_pdf_os2']."</label></td></tr>
						<tr><td>".$Acompanhante["Nom_Nome"]."</td></tr>
					</table>
				</td>
				<td class='col-4' colspan='4'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_email']."</label></td></tr>
						<tr><td>".$Acompanhante["Email"]."</td></tr>
					</table></td>
				<td class='col-4' colspan='4'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_phone']."</label></td></tr>
						<tr><td>".$Acompanhante["Telefone"]."</td></tr>
					</table>
				</td>
			</tr>
			<tr>
				<td class='col-6' colspan='6'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_operator']."</label></td></tr>
						<tr><td>".$Sae["Nom_Operadora"]."</td></tr>
					</table>
				</td>
				<td class='col-6' colspan='6'>
					<table class='label-top col-12'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_provider']."</label></td></tr>
						<tr><td>".$Sae["Nom_Prestadora"]."</td></tr>
					</table>
				</td>
			</tr>
		</table>
		...
		<table class='col-12 center'>
			<tr class='header'>
				<td class='col-1' colspan='1'><label>".$this->Ini->Nm_lang['lang_label_date']."</label></td>
				<td class='col-6' colspan='6'><label>".$this->Ini->Nm_lang['lang_label_pdf_os3']."</label></td>
				<td class='col-5' colspan='5'><label>".$this->Ini->Nm_lang['lang_label_schedule']."</label></td>
			</tr>
			<tr>
				<td class='col-1' colspan='1'>".$Sae["Data_Inicio"]."</td>
				<td class='col-6' colspan='6'>".strtr($Sae["Desc"], ["\n"=>"<br>"])."</td>
				<td class='col-2' colspan='2'>
					<table class='label-top col-12 center'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_start']."</label></td></tr>
						<tr><td>".$Sae["Data_1"]."</td></tr>
					</table>
				</td>
				<td class='col-2' colspan='2'>
					<table class='label-top col-12 center'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_end']."</label></td></tr>
						<tr><td>".$Sae["Data_2"]."</td></tr>
					</table>
				</td>
				<td class='col-1' colspan='1'>
					<table class='label-top col-12 center'>
						<tr><td><label>".$this->Ini->Nm_lang['lang_label_pdf_os4']."</label></td></tr>
						<tr><td>".$Sae["Total_Horas"]."</td></tr>
					</table>
				</td>
			</tr>
			<tr class='header center'>
				<td class='col-12' colspan='12'><label>".$this->Ini->Nm_lang['lang_label_observation']."</label></td>
			</tr>
			<tr>
				<td class='col-12' colspan='12'>".strtr($Os["Observacoes"], ["\n" => "<br>"])."</td>
			</tr>
		</table>
		<p style='font-size:3px'>&nbsp;</p>
		<table class='col-12'>
			<tr>
				<td class='col-12' colspan='12'>
					– ".$this->Ini->Nm_lang['lang_label_pdf_os5']." <br>
					– ".$this->Ini->Nm_lang['lang_label_pdf_os6']." <br>
					– ".$this->Ini->Nm_lang['lang_label_pdf_os7']." <br>
					– ".$this->Ini->Nm_lang['lang_label_pdf_os8']." 
				</td>
			</tr>
			<tr>
				<td class='col-6' colspan='6'>
					<table class='label-top col-12'>
						<tr><td class='center'><label>".$this->Ini->Nm_lang['lang_label_condominio_upc']."</label></td></tr>
						<tr>
							<td>
							<div class='center'><img class='ass' src='".$Os["Img_AssCondominio"]."'></div>
							<div><label>".$this->Ini->Nm_lang['lang_label_name']."</label>: ".$Os["Nom_AssCondominio"]."</div>
							<div><label>RG</label>: ".($Os["RG_AssCondominio"] ? mask($Os["RG_AssCondominio"], ["#.###.###-#", "##.###.###-#", "###.###.###-#"]) : "")."</div>
							</td>
						</tr>
					</table>
				</td>
				<td class='col-6' colspan='6'>
					<table class='label-top col-12'>
						<tr><td class='center'><label>".$this->Ini->Nm_lang['lang_label_op_prov_upc']."</label></td></tr>
						<tr>
							<td>
							<div class='center'><img class='ass' src='".$Os["Img_AssOP"]."'></div>
							<div><label>".$this->Ini->Nm_lang['lang_label_name']."</label>: ".$AssTecnico["Nom_Nome"]."</div>
							<div><label>RG</label>: ".($AssTecnico["Num_RG"] ? mask($AssTecnico["Num_RG"], ["#.###.###-#", "##.###.###-#", "###.###.###-#"]) : "")."</div>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td class='col-6' colspan='6'>
					<table class='label-top col-12'>
						<tr><td class='center'><label>".$this->Ini->Nm_lang['lang_label_gb_consulttec_upc']."</label></td></tr>
						<tr>
							<td>
							<div class='center'><img class='ass' src='".$Os["Img_AssGB"]."'></div>
							<div><label>".$this->Ini->Nm_lang['lang_label_name']."</label>: ".$AssGB["Nom_Nome"]."</div>
							<div><label>RG</label>: ".($AssGB["Num_RG"] ? mask($AssGB["Num_RG"], ["#.###.###-#", "##.###.###-#", "###.###.###-#"]) : "")."</div>
							</td>
						</tr>
					</table>
				</td>
				<td class='col-6' colspan='6'>
					<table class='label-top col-12'>
						<tr><td class='center'><label>".$this->Ini->Nm_lang['lang_label_gb_controller_upc']."</label></td></tr>
						<tr>
							<td>
							<div class='center'><img class='ass' src='".$Os["Img_AssControladoria"]."'></div>
							<div><label>".$this->Ini->Nm_lang['lang_label_name']."</label>: ".$Os["Nom_AssControladoria"]."</div>
							<div><label>RG</label>: ".($Os["RG_AssControladoria"] ? mask($Os["RG_AssControladoria"], ["#.###.###-#", "##.###.###-#", "###.###.###-#"]) : "")."</div>
							</td>
						</tr>
					</table>
				</td>
...
";
$dompdf->loadHtml($contentOS);
$dompdf->setPaper('A4', 'landscape');
$dompdf->render();

$dompdf->stream("OS_$Num_SAE.pdf", array("Attachment" => false));

if (isset($this->sc_temp_form_OS_ID)) {$_SESSION['form_OS_ID'] = $this->sc_temp_form_OS_ID;}
if (isset($this->sc_temp_form_OS_Num_SAE)) {$_SESSION['form_OS_Num_SAE'] = $this->sc_temp_form_OS_Num_SAE;}
$_SESSION['hticnsdata']['blk_OS_PDFView']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blk_OS_PDFView($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($_POST["form_OS_Num_SAE"])) 
   {
       $_SESSION["form_OS_Num_SAE"] = $_POST["form_OS_Num_SAE"];
       nm_limpa_str_blk_OS_PDFView($_SESSION["form_OS_Num_SAE"]);
   }
   ...
   if (isset($_GET["form_OS_Num_SAE"])) 
   {
       $_SESSION["form_OS_Num_SAE"] = $_GET["form_OS_Num_SAE"];
       nm_limpa_str_blk_OS_PDFView($_SESSION["form_OS_Num_SAE"]);
   }
   ...
   if (!isset($_SESSION["form_OS_Num_SAE"])) 
   {
       $_SESSION["form_OS_Num_SAE"] = "";
   }
   if (isset($_POST["form_OS_ID"])) 
   {
       $_SESSION["form_OS_ID"] = $_POST["form_OS_ID"];
       nm_limpa_str_blk_OS_PDFView($_SESSION["form_OS_ID"]);
   }
   ...
   if (isset($_GET["form_OS_ID"])) 
   {
       $_SESSION["form_OS_ID"] = $_GET["form_OS_ID"];
       nm_limpa_str_blk_OS_PDFView($_SESSION["form_OS_ID"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['iframe_menu'];
       unset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['initialize']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blk_OS_PDFView' == $sReferer || 'blk_OS_PDFView_' == substr($sReferer, 0, 15))
       {
           $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['hticnsdata']['sc_outra_jan']) && $_SESSION['hticnsdata']['sc_outra_jan'] == 'blk_OS_PDFView')
   {
       $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['sc_outra_jan'] = true;
        unset($_SESSION['hticnsdata']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$hti_cnsdata_init]['blk_OS_PDFView']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blk_OS_PDFView_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blk_OS_PDFView($cadapar[1]);
       ...
       if (!isset($form_OS_Num_SAE) && isset($form_os_num_sae)) 
       {
           $_SESSION["form_OS_Num_SAE"] = $form_os_num_sae;
       }
       if (isset($form_OS_Num_SAE)) 
       {
           $_SESSION['form_OS_Num_SAE'] = $form_OS_Num_SAE;
           nm_limpa_str_blk_OS_PDFView($_SESSION["form_OS_Num_SAE"]);
       }
       if (!isset($form_OS_ID) && isset($form_os_id)) 
       {
           $_SESSION["form_OS_ID"] = $form_os_id;
       }
       if (isset($form_OS_ID)) 
       {
           $_SESSION['form_OS_ID'] = $form_OS_ID;
   ...
   $contr_blk_OS_PDFView = new blk_OS_PDFView_apl();
   $contr_blk_OS_PDFView->controle();
//
   function nm_limpa_str_blk_OS_PDFView(&$str)
   {
